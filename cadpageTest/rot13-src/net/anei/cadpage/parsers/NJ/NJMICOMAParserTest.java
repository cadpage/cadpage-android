...
vzcbeg arg.narv.pnqcntr.cnefref.AW.AWZVPBZNCnefre;
...
choyvp pynff AWZVPBZNCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp AWZVPBZNCnefreGrfg() {
    frgCnefre(arj AWZVPBZNCnefre(), "", "AW");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj AWZVPBZNCnefreGrfg().trarengrGrfgf("G1");
  }
}