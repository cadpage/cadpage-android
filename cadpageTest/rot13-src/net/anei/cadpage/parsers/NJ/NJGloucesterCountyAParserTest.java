...
choyvp pynff AWTybhprfgrePbhaglNCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  @Grfg
  choyvp ibvq grfgWbuaTbyqvfu() {

    qbGrfg("G1",
        "PBHAGL BS TYBHPRFGRE (#353135) Qvfcngpu\a\a" +
        "Fgn:10-3\a" +
        "Glcr:NYEZ\a" +
        "Ybp:5600 OYNPX UBEFR CVXR         \a" +
        "Ira:JNFUVATGBA\a" +
        "Qfc-04:11:36     \a" +
        "Pye- FGBC",
  ...
  choyvp ibvq grfgWbuaTbqvfu() {
    ...
    qbGrfg("G1",
        ...
        "FEP:10-3",
        "PNYY:JVER",
        "NQQE:PUNCRY URVTUGF EQ",
        "PVGL:JNFUVATGBA GJC");

  }
  
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj AWTybhprfgrePbhaglNCnefreGrfg().trarengrGrfgf("G1", "FEP PNYY NQQE NCG PVGL GVZR");
  }
}