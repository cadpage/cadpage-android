...
Pbagnpg: Zvxr Pnql <zvxrpnqltn@tznvy.pbz>
Fraqre: cbfgznfgre@juvgsvryq.pbz
(Nf bs 2/29/16 16:08:13) 2016-00029228\aS15 - SVER NYNEZ\a1102 Oheyrlfba EQ, QNYGBA\aQNYGBA\a218
(Nf bs 2/22/16 09:14:13) 2016-00025454\aS15 - SVER NYNEZ\a101 F Fryivqtr FG, QNYGBA\aQNYGBA
...
choyvp pynff TNJuvgsvryqPbhaglOCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp TNJuvgsvryqPbhaglOCnefreGrfg() {
    frgCnefre(arj TNJuvgsvryqPbhaglOCnefre(), "JUVGSVRYQ PBHAGL", "TN");
  }
  
  @Grfg
  choyvp ibvq grfgZvxrPnql() {
  ...
  choyvp ibvq grfgZvxrPnql2() {
    ...
    qbGrfg("G2",
        ...
        "PBQR:S15",
        "PNYY:SVER NYNEZ",
        "NQQE:101 F Fryivqtr FG",
        "PVGL:QNYGBA");
    
  }
  
  @Grfg
  choyvp ibvq grfgSversvtugre1050() {

    qbGrfg("G1",
        "1 bs 2\a" +
        "SEZ:CntrTngr@juvgsvryqpbhagltn.pbz\a" +
        "FHOW:Nf bs 1/27/15 11\a" +
        "ZFT::Nf bs 1/27/15 11:33:19 2015-00010085 Z6R - OERNGUVAT CEBOYRZF 329 Purebxrr\a" +
        "(Pba'g) 2 bs 2\a" +
        "GE AJ, QNYGBA QNYGBA Havg Bet Anzr Nern Glcrf JR1 JUVGSVRYQ PBHAGL SVER QRCG FGN 1 J(Raq)",
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj TNJuvgsvryqPbhaglOCnefreGrfg().trarengrGrfgf("G1");
  }
}
