...
choyvp pynff GKYrbaPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp GKYrbaPbhaglCnefreGrfg() {
    frgCnefre(arj GKYrbaPbhaglCnefre(), "YRBA PBHAGL", "GK");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj GKYrbaPbhaglCnefreGrfg().trarengrGrfgf("G1");
  }
}
