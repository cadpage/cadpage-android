...
choyvp pynff GAJvyyvnzfbaPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp GAJvyyvnzfbaPbhaglCnefreGrfg() {
    frgCnefre(arj GAJvyyvnzfbaPbhaglCnefre(), "JVYYVNZFBA PBHAGL", "GA");
  }
