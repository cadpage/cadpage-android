...
choyvp pynff APJnlarPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj APJnlarPbhaglCnefreGrfg().trarengrGrfgf("G1", "PNYY NQQE FEP PVGL VQ");
  }
}
