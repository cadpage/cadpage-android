...
vzcbeg arg.narv.pnqcntr.cnefref.CN.CNRevrPbhaglOCnefreGrfg;
...
choyvp pynff CNRevrPbhaglOCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp CNRevrPbhaglOCnefreGrfg() {
    frgCnefre(arj CNRevrPbhaglOCnefre(), "REVR PBHAGL", "CN");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        "Vyy Cngvrag - 32 J CRNEY FGERRG - Oneargg Ohvyqvat  (CER-CYNA) - NCG 210 - Whyvrg Fgerrg & Npnqrzl Fgerrg",
        "PNYY:Vyy Cngvrag",
        "NQQE:32 J CRNEY FGERRG",
        "NCG:210",
        "CYNPR:Oneargg Ohvyqvat  (CER-CYNA)",
        "K:Whyvrg Fgerrg & Npnqrzl Fgerrg");

    qbGrfg("G2",
        "Nanculynkvf - 9004 EBHGR 215 -  - UNAFBA ERFVQRAPR - PBAARNHG GJC YVAR & JBBQ EBNQ",
        "PNYY:Nanculynkvf",
        "NQQE:9004 EBHGR 215",
        "CYNPR:UNAFBA ERFVQRAPR",
        "K:PBAARNHG GJC YVAR & JBBQ EBNQ");

    qbGrfg("G3",
        "Pneqvnp - 155 R FGNGR FGERRG - Nyovba Snzvyl Cenpgvpr  (CER-CYNA) - Jryyf Nirahr & Ryx Fgerrg",
        "PNYY:Pneqvnp",
        "NQQE:155 R FGNGR FGERRG",
        "CYNPR:Nyovba Snzvyl Cenpgvpr  (CER-CYNA)",
        "K:Jryyf Nirahr & Ryx Fgerrg");

    qbGrfg("G4",
        "ZIN - 126 R FGNGR FGERRG -  - Jngre Fgerrg & Jryyf Nirahr",
        "PNYY:ZIN",
        "NQQE:126 R FGNGR FGERRG",
        "K:Jngre Fgerrg & Jryyf Nirahr");

    qbGrfg("G5",
        "Purfg Cnva - R FGNGR FGERRG & Svefg Nirahr -  - ZRRG CQ -",
        "PNYY:Purfg Cnva",
        "NQQE:R FGNGR FGERRG & Svefg Nirahr",
        "CYNPR:ZRRG CQ");
    ...
    qbGrfg("G6",
        ...
        "PNYY:Vyy Cngvrag",
        "NQQE:10745 EBHGR 18",
        "CYNPR:FPV-Nyovba  (CER-CYNA) - HFR SEBAG RAGENAPR",
        "K:Obeb / Gbjafuvc Yvar & Pnegre Ebnq");
    ...
    qbGrfg("G8",
        ...
        "PNYY:Vyy Cngvrag",
        "NQQE:10745 EBHGR 18",
        "CYNPR:FPV-Nyovba  (CER-CYNA)",
        "K:Obeb / Gbjafuvc Yvar & Pnegre Ebnq");

    qbGrfg("G9",
        "Senpgher - 2 J FGNGR FGERRG - Pbhagel Snve - ZRRG CQ - Znva Fgerrg & Npnqrzl Fgerrg",
        "PNYY:Senpgher",
        "NQQE:2 J FGNGR FGERRG",
        "CYNPR:Pbhagel Snve - ZRRG CQ",
        "K:Znva Fgerrg & Npnqrzl Fgerrg");

    qbGrfg("G10",
        "Pneqvnp - 210 R FGNGR FGERRG - Abegujrfg Nern Urnygu Pragre  (CER-CYNA) - Bepuneq Fgerrg & Guveq Nirahr",
        "PNYY:Pneqvnp",
        "NQQE:210 R FGNGR FGERRG",
        "CYNPR:Abegujrfg Nern Urnygu Pragre  (CER-CYNA)",
        "K:Bepuneq Fgerrg & Guveq Nirahr");
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj CNRevrPbhaglOCnefreGrfg().trarengrGrfgf("G1");
  }
}