...
choyvp pynff CNYnpxnjnaanPbhaglNzohynaprCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp CNYnpxnjnaanPbhaglNzohynaprCnefreGrfg() {
    frgCnefre(arj CNYnpxnjnaanPbhaglNzohynaprCnefre(), "YNPXNJNAAN PBHAGL", "CN");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G5",
        ...
        "GVZR:08:14:00",
        "VQ:1219854-1",
        "NQQE:RIRETERRA UPP - sbezreyl ZGU Fxvyyrq",
        "NCG:7",
        "PNYY:QE NCCBVAGZRAG CG:Oneonen Znegva",
        "VASB:QRYGN ZRQVK -");
    ...
    qbGrfg("G6",
        ...
        "NCG:Aryiryyr Unyy Ez 107",
        "PVGL:FPENAGBA PVGL",
        "PNYY:HAXABJA");
  }
  
  choyvp fgngvp ibvq znva(Fgevat netf[]) {
    arj CNYnpxnjnaanPbhaglNzohynaprCnefreGrfg().trarengrGrfgf("G1");
  }
}