...
choyvp pynff CNPurfgrePbhaglRCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp CNPurfgrePbhaglRCnefreGrfg() {
    frgCnefre(arj CNPurfgrePbhaglRCnefre(), "PURFGRE PBHAGL", "CN");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        ...
        "NQQE:880 J ONYGVZBER CX",
        "ZNQQE:880 J ONYGVZBER CVXR",
        "K:YRJVF EQ & CHFRL ZVYY EQ",
        "PVGL:CRAA GJC",
        "CYNPR:JRYYARFF PRAGRE BSSVPR-FBHGURE",
        "ANZR:TENAQRY,");
    ...
    qbGrfg("G3",
        ...
        "NQQE:774 J TYRAIVRJ QE",
        "K:CURNFNAG JL & RQTRJBBQ PG",
        "PVGL:CRAA GJC",
        "CUBAR:610-345-136",
        "HAVG:2203",
        "FEP:22");
    ...
    qbGrfg("G4",
        ...
        "PNYY:ONEA SVER",
        "NQQE:248 UBBQ EQ",
        "K:ZHAVPVCNY OBHAQNEL & A ZBFDHVGB YN",
    ...
    qbGrfg("G7",
        ...
        "NQQE:JO J NIBAQNYR EQ JB FGNGR EQ",
        "ZNQQE:J NIBAQNYR EQ & FGNGR EQ",
        "PVGL:ARJ YBAQBA GJC",
        "CUBAR:P610-299-21",
        "HAVG:1202",
        "FEP:12");
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj CNPurfgrePbhaglRCnefreGrfg().trarengrGrfgf("G1");
  }
}
