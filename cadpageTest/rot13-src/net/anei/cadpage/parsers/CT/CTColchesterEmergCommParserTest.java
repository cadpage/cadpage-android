...
choyvp pynff PGPbypurfgreRzretPbzzCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp PGPbypurfgreRzretPbzzCnefreGrfg() {
    frgCnefre(arj PGPbypurfgreRzretPbzzCnefre(), "", "PG");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        "PBYPURFGRE\\ 25 IVYYNTR PG\\ \\@  NZFGBA EQ\\ SNVAGVAT BE HAPBAP. CREF\\ IBTRY,UREOREG U \\  ** 12-6474  \\ 11:42 ** ZncVg:  25  IVYYNTR PG, PBYPURFGRE , PG ( HAPBAFPVBHF )",
        "PVGL:PBYPURFGRE",
        "NQQE:25 IVYYNTR PG", //*** ABG SBHAQ ***
        "K:NZFGBA EQ",
        "PNYY:SNVAGVAT BE HAPBAP. CREF",
        "ANZR:IBTRY,UREOREG U",
        "VQ:12-6474",
        "GVZR:11:42",
        "VASB:HAPBAFPVBHF");
    ...
    qbGrfg("G2",
        "PBYPURFGRE\\ 15 BYQ UNEGSBEQ EQ\\ \\@  JNYY FG\\ QVSSVPHYGL OERNGUVAT\\ FGNGR CBYVPR GEBBC X - YBOOL \\  ** 12-6456  \\ 05:21 ** ZncVg:  15  BYQ UNEGSBEQ EQ, PBYPURFGRE , PG",
        "PVGL:PBYPURFGRE",
        "NQQE:15 BYQ UNEGSBEQ EQ",
        "K:JNYY FG",
        "PNYY:QVSSVPHYGL OERNGUVAT",
        "CYNPR:FGNGR CBYVPR GEBBC X - YBOOL",
        "VQ:12-6456",
        "GVZR:05:21");
    ...
    qbGrfg("G4",
        ...
        "VQ:12-6400",
        "GVZR:23:17",
        "VASB:40F ZNYR - NGGA T YNXR E2 ZHGHNY NVQ");
    ...
    qbGrfg("G5",
        ...
        "K:BYQ UROEBA EQ",
        "PNYY:NYYRET. ERNPG",
        "ANZR:PVAPVEVCVAB,WRSSERL",
        "VQ:12-6342",
        "GVZR:00:32",
        "VASB:27 ZNYR ERNPGVBA GB ZRQVPNGVBA");
