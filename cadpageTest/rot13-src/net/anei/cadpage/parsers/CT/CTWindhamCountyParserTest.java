...
choyvp pynff PGJvaqunzPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp PGJvaqunzPbhaglCnefreGrfg() {
    frgCnefre(arj PGJvaqunzPbhaglCnefre(), "JVAQUNZ PBHAGL", "PG");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj PGJvaqunzPbhaglCnefreGrfg().trarengrGrfgf("G1", "FEP HAVG PU CEV PNYY NQQE CYNPR PVGL K GVZR");
  }
}