...
Pbagnpg: Fgrir Urff <FUrff@fvzfohelsq.bet>
Fraqre: 4702193824
Fvzfohel Sver Qrcg: 26 PNEFBA JNL GLCR:QB DHRFGVBANOYL FNSR URNG HAVG VA UBHFR HAQRE PBAFGEHPGVBA: QB BAYL F34 ERFCBAQVAT
Fvzfohel Sver Qrcg: RYNVAR QE&YVBARY QE GLCR:JQ CBFFVOYR GENAFSBEZRE SVER, R7, R8 UBG

*/

choyvp pynff PGFvzfohelCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp PGFvzfohelCnefreGrfg() {
    frgCnefre(arj PGFvzfohelCnefre(), "FVZFOHEL", "PG");
  }
  
  @Grfg
  choyvp ibvq grfgNaqerjTnvarf() {
    ...
    qbGrfg("G1",
        ...
        "PBQR:FS",
        "PNYY:Fgehpgher Sver",
        "VASB:arj bira znxvat abvfrf fzryyf yvxr oheavat ehoore");

    qbGrfg("G2",
        "530 OHFUL UVYY EQ Fhvgr: 03 GLCR:SN",
        "NQQE:530 OHFUL UVYY EQ",
        "NCG:03",
        "PBQR:SN",
        "PNYY:Sver Nynez");
    ...
    qbGrfg("G3",
        "235 SNEZF IVYYNTR EQ GLCR:IN 2 PNE ZIN JVGU SYHVQF",
        "NQQE:235 SNEZF IVYYNTR EQ",
        "PBQR:IN",
        "PNYY:Iruvpyr Nppvqrag",
        "VASB:2 PNE ZIN JVGU SYHVQF");

    qbGrfg("G4",
        "OHFUL UVYY EQ&BIREYBBX GRE GLCR:IE. ERCBEGRQ CNEGL RAGENCG",
        "NQQE:OHFUL UVYY EQ & BIREYBBX GRE",
        "PBQR:IE",
        "PNYY:Iruvpyr Erfphr",
        "VASB:ERCBEGRQ CNEGL RAGENCG");

    qbGrfg("G5",
        "57 JRFG ZBHAGNVA EQ GLCR:IN PNE BSS EBNQ VAGB GERR. CBYVPR BA FPRAR ERD SQ",
        "NQQE:57 JRFG ZBHAGNVA EQ",
        "PBQR:IN",
        "PNYY:Iruvpyr Nppvqrag",
        "VASB:PNE BSS EBNQ VAGB GERR. CBYVPR BA FPRAR ERD SQ");
    ...
    qbGrfg("G6",
        ...
        "PBQR:FN",
        "PNYY:Fzbxr va Nern",
        "VASB:fzryy bs fzbxr va nern - pna frr \"svyz\" va nve");

    qbGrfg("G7",
        "UBCZRNQBJ FG&JBBQYNAQ FG GLCR:CN Gehpx uvg gryrcubar cbyr fbhgu bs Jbbqynaq Fgerrg npebff sebz QO oernxvat gur thvqr jver. Cbyvpr er dhrfg SQ purpx cbyr.",
        "NQQE:UBCZRNQBJ FG & JBBQYNAQ FG",
        "PBQR:CN",
        "PNYY:Cbyvpr Nffvfg",
        "VASB:Gehpx uvg gryrcubar cbyr fbhgu bs Jbbqynaq Fgerrg npebff sebz QO oernxvat gur thvqr jver. Cbyvpr er dhrfg SQ purpx cbyr.");
    ...
    qbGrfg("G10",
        "OHFUL UVYY EQ&NYONAL GACX GLCR:IE zin ebyybire j/rkgevpngvba",
        "NQQE:OHFUL UVYY EQ & NYONAL GACX",
        "PBQR:IE",
        "PNYY:Iruvpyr Erfphr",
        "VASB:zin ebyybire j/rkgevpngvba");
  }
  
  @Grfg
  choyvp ibvq grfgYrivYvyyl() {
  ...
  @Grfg
  choyvp ibvq grfgFgrirUrff() {

    qbGrfg("G1",
        "Fvzfohel Sver Qrcg: 26 PNEFBA JNL GLCR:QB DHRFGVBANOYL FNSR URNG HAVG VA UBHFR HAQRE PBAFGEHPGVBA: QB BAYL F34 ERFCBAQVAT",
        "FEP:Fvzfohel Sver Qrcg",
        "NQQE:26 PNEFBA JNL",
        "PBQR:QB",
        "PNYY:Qhgl Bssvpre",
        "VASB:DHRFGVBANOYL FNSR URNG HAVG VA UBHFR HAQRE PBAFGEHPGVBA: QB BAYL F34 ERFCBAQVAT");

    qbGrfg("G2",
        "Fvzfohel Sver Qrcg: RYNVAR QE&YVBARY QE GLCR:JQ CBFFVOYR GENAFSBEZRE SVER, R7, R8 UBG",
        "FEP:Fvzfohel Sver Qrcg",
        "NQQE:RYNVAR QE & YVBARY QE",
        "PBQR:JQ",
        "PNYY:Jverf Qbja",
        "VASB:CBFFVOYR GENAFSBEZRE SVER, R7, R8 UBG");
   
  }
  
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj PGFvzfohelCnefreGrfg().trarengrGrfgf("G1");
  }
}