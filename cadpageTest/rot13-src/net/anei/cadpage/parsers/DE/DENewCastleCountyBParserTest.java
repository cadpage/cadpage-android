...
choyvp pynff QRArjPnfgyrPbhaglOCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp QRArjPnfgyrPbhaglOCnefreGrfg() {
    frgCnefre(arj QRArjPnfgyrPbhaglOCnefre(), "ARJ PNFGYR PBHAGL", "QR");
  }
  
  @Grfg
  choyvp ibvq grfgOnq() {
    qbOnqGrfg("(Puvrs NYG) [FGN:7] -- NYF -- 118 R Cvggfsvryq Fg Craafivyyr Gbjafuvc AW - Pebff FGF:Fcnexf Nir -- Pnyyre: QNHYGBA"); 
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        ...
        "CYNPR:Nzorejbbq",
        "NQQE:51 Xneraf Jl",
        "K:Orrpujbbq Pg & Fvyire Ovepu Yn",
        "PBQR:Z31Q3");
    ...
    qbGrfg("G2",
        ...
        "FEP:PSP RZF",
        "PNYY:Zrqvpny Nynez",
        "CYNPR:Sberfg Tyra Gbjaufrf",
        "NQQE:3 Cvzyvpb Yn",
        "ZNQQE:3 Cvzyvpb Ya",
        "K:Ehr Znqben & Qrnq Raq",
        "PBQR:Z32O2");
    ...
    qbGrfg("G3",
        ...
        "CYNPR:Fhzzrefrg Fdhner Gbjaufrf",
        "NQQE:4 Pnaqyrjvpx Pg",
        "PVGL:Arj Pnfgyr",
        "FG:QR",
        "K:Jvygba Oy & Qrnq Raq",
        "PBQR:Z1N1");
    ...
    qbGrfg("G4",
        ...
        "CYNPR:Jnjn Fnyrz Pragre - Fnyrz Pragre Fubc Pge",
        "NQQE:1605 Chynfxv Ul",
        "ZNQQE:1605 Chynfxv Ujl",
        "K:Tynftbj Qe & Fnyrz Puhepu Eq",
        "PBQR:Z4O3");
    ...
    qbGrfg("G5",
        ...
        "PNYY:Nffnhyg",
        "CYNPR:Qnlf Vaa",
        "NQQE:900 Puhepuznaf Eq",
        "NCG:122",
        "PVGL:Arjnex",
        "FG:QR",
        "K:Egr 1 Fo & Byq Puhepuznaf Eq",
        "PBQR:Z4O1N");
    ...
    qbGrfg("G6",
        ...
        "CYNPR:Puevfgvnan Zrnqbjf Ncgf",
        "NQQE:401 Puevfgvnan Zrnqbjf",
        "K:Orne Puevfgvnan Eq",
        "PBQR:Z23P1V");
    ...
    qbGrfg("G7",
        ...
        "CYNPR:Zrqvpny Negf Cni 1",
        "NQQE:4745 Fgnagba Btyrgbja Eq",
        "K:Fnzbfrg Qe & Ultrvn Qe",
        "PBQR:52P1T");
    ...
    qbGrfg("G8",
        ...
        "CYNPR:Pebffvatf Ng Puevfgvnan Gbjaufrf",
        "NQQE:216 Tynqfgbar Jl",
        "K:Qrnq Raq & Onxre Qe",
        "PBQR:Z28P4P");
    ...
    qbGrfg("G9",
        ...
        "FEP:PSP RZF",
        "PNYY:Crefba Snyyra",
        "CYNPR:Uvyyfvqr Urvtugf",
        "NQQE:109 Ebfrjbbq Qe",
        "K:Terragerr Eq & Yniraqre Yn",
        "PBQR:Z17O1");
    ...
    qbGrfg("G10",
        ...
        "CYNPR:Qverpg Enqvbtencul - Tynftbj Ohfvarff Pbzzhavgl",
        "NQQE:600 Grpuabybtl Qe",
        "K:Top Qe & Lbba Yn",
        "PBQR:52P3T");
    ...
    qbGrfg("G11",
        ...
        "CYNPR:Vagrefgngr 95",
        "NQQE:Puhepuznaf Eq & V95 Fo",
        "ZNQQE:Puhepuznaf Eq & V 95",
        "PBQR:Z29O4");
  }
  
  @Grfg
  choyvp ibvq grfgWnfbaEbff() {

    qbGrfg("G1",
        "[Puvrs NYG]  [PSP Sver] -- Y3*erfvqragvny Sver -- Yynatbyyra Rfgngrf -- 218 Fbhgureynaq Qe Arj Pnfgyr - Pebff FGF:Zraqryy Cy & Tbeql Cy - RZQ:69Q6 - Abgrf:CEBDN QRGNVY",
        "FEP:PSP Sver",
        "PNYY:Y3*erfvqragvny Sver",
        "CYNPR:Yynatbyyra Rfgngrf",
        "NQQE:218 Fbhgureynaq Qe",
        "PVGL:Arj Pnfgyr",
        "K:Zraqryy Cy & Tbeql Cy",
        "PBQR:69Q6");
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj QRArjPnfgyrPbhaglOCnefreGrfg().trarengrGrfgf("G1");
  }
}
