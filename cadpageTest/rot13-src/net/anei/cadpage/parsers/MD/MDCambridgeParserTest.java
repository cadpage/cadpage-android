...
vzcbeg arg.narv.pnqcntr.cnefref.ZQ.ZQPnzoevqtrCnefre;
...
Pbagnpg: Wrss Yrjvf <wrss.yrjvf37@lnubb.pbz>
Fraqre: QBE911@qbpbtbarg.pbz
QBE911:PNAPRY YNFG NYREG NHGU BS NYNEZ PB 835 :QP\e

***/

choyvp pynff ZQPnzoevqtrCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp ZQPnzoevqtrCnefreGrfg() {
    frgCnefre(arj ZQPnzoevqtrCnefre(), "PNZOEVQTR", "ZQ");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj ZQPnzoevqtrCnefreGrfg().trarengrGrfgf("G1", "PNYY NQQE PVGL CYNPR OBK HAVG");
  }
}