...
vzcbeg arg.narv.pnqcntr.cnefref.VQ.VQTbbqvatPbhaglOCnefreGrfg;
...
choyvp pynff VQTbbqvatPbhaglOCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp VQTbbqvatPbhaglOCnefreGrfg() {
    frgCnefre(arj VQTbbqvatPbhaglOCnefre(), "TBBQVAT PBHAGL", "VQ");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        ...
        "ZFT:1/19/2015 1922\a" +
        "RIRAG # 1501190236 ZIE039\a" +
        "ZRQ - ZRQVPNY PNYY\a" +
        "CEVBEVGL 1 \a" +
        "YBPNGVBA 1521 CBCYNE\a" +
        "(Pba'g) 2 bs 2\a" +
        "NIR\a" +
        "PVGL GJVA SNYYF\a" +
        "NCG \a" +
        "CERZVFR \a" +
        "PBZZRAG 70 LB SRZNYR\a" +
        "SRYY, ARRQF N YVSG NFFVFG\a" +
        "(Raq)",
        ...
        "CEV:1",
        "NQQE:1521 CBCYNE NIR",
        "PVGL:GJVA SNYYF",
        "VASB:70 LB SRZNYR / SRYY, ARRQF N YVSG NFFVFG");

    qbGrfg("G2",
        "1 bs 2\a" +
        "SEZ:CntvatFreivpr@fvepbzz.pbz\a" +
        "ZFT:1/20/2015 0825\a" +
        "RIRAG # 1501200040 ZIE039\a" +
        "NYZ - ZRQVPNY NYNEZ\a" +
        "CEVBEVGL 1 \a" +
        "YBPNGVBA 834 20GU NIR\a" +
        "(Pba'g) 2 bs 2\a" +
        "R\a" +
        "PVGL WREBZR\a" +
        "NCG \a" +
        "CERZVFR \a" +
        "PBZZRAG 67 LBS-SRYY\a" +
        "YRSG SBBG VF FJBYYRA\a" +
        "OEBHVFVAT NAQ OYBBQ BA UR...\a" +
        "(Raq)",
        ...
        "VQ:1501200040",
        "FEP:ZIE039",
        "PNYY:NYZ - ZRQVPNY NYNEZ",
        "CEV:1",
        "NQQE:834 20GU NIR R",
        "PVGL:WREBZR",
        "VASB:67 LBS-SRYY / YRSG SBBG VF FJBYYRA / OEBHVFVAT NAQ OYBBQ BA UR...");

    qbGrfg("G3",
        "1 bs 2\a" +
        "SEZ:CntvatFreivpr@fvepbzz.pbz\a" +
        "ZFT:1/20/2015 0844\a" +
        "RIRAG # 1501200045 ZIE039\a" +
        "ZRQ - ZRQVPNY PNYY\a" +
        "CEVBEVGL 1 \a" +
        "YBPNGVBA 623 JVAQRZRER\a" +
        "(Pba'g) 2 bs 2\a" +
        "QE\a" +
        "PVGL GJVA SNYYF\a" +
        "NCG 101\a" +
    ...
    qbGrfg("G4",
        "1 bs 2\a" +
        "SEZ:CntvatFreivpr@fvepbzz.pbz\a" +
        "ZFT:1/20/2015 0918\a" +
        "RIRAG # 1501200082 ZIE039\a" +
        "ZRQ - ZRQVPNY PNYY\a" +
        "CEVBEVGL 1 \a" +
        "YBPNGVBA 1828 OEVQTRIVRJ\a" +
        "(Pba'g) 2 bs 2\a" +
        "OYIQ\a" +
        "PVGL GJVA SNYYF\a" +
        "NCG 226\a" +
        "CERZVFR OEVQTRIVRJ RFGNGRF\a" +
        "PBZZRAG 90 LBS-AHZOARFF VA URE NEZ\a" +
        "FUBEG BS OERNGU\a" +
        "PBAF\a" +
        "EC VF ABG...\a" +
        "(Raq)",
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj VQTbbqvatPbhaglOCnefreGrfg().trarengrGrfgf("G1");
  }
}