...
(SPP Cntr) Vapvqrag Qvfcngpu:G30   HAPBAFPVBH190 R Uvyyperfg Qe            556-S1 38/3912-0059237
(SPP Cntr) Vapvqrag Qvfcngpu:G30   SNYYF ABA 3557 Pnzchf Qe                526-R2 38/3912-0059231
(SPP Cntr) Vapvqrag Qvfcngpu:G30   VAIRFGVTNGF Zbbecnex Eq / Ebyyvat Bnxf Q556-S2 38/3912-0058857
...
Pbagnpg: Qhfgva Ynmraol <pncgynm82@tznvy.pbz>
Fraqre: SPP-QB-ABG-ERCYL@iraghen.bet
...
choyvp pynff PNIraghenPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G6",
        ...
        "HAVG:G30",
        "PNYY:VAIRFGVTNG",
        "NQQE:F Zbbecnex Eq & Ebyyvat Bnxf Q",
        "ZNC:556-S2",
        "PU:38/39",
        "VQ:12-0058857");
  ...
  @Grfg
  choyvp ibvq grfgQhfgvaYnmraol() {

    qbGrfg("G1",
        "(SPP Cntr) Vapvqrag Qvfcngpu:  R81    OERNGUVAT  100-oybpx A 4gu Fg             464-N6  5 / 6  13-0013620",
        "HAVG:R81",
        "PNYY:OERNGUVAT",
        "NQQE:100-oybpx A 4gu Fg",
        "ZNQQE:100 A 4gu Fg",
        "ZNC:464-N6",
        "PU:5/6",
        "VQ:13-0013620");
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj PNIraghenPbhaglCnefreGrfg().trarengrGrfgf("G1");
  }
}