 ...
 */
choyvp pynff BUNfuynaqPbhaglNCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp BUNfuynaqPbhaglNCnefreGrfg() {
    frgCnefre(arj BUNfuynaqPbhaglNCnefre(), "NFUYNAQ PBHAGL", "BU");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj BUNfuynaqPbhaglNCnefreGrfg().trarengrGrfgf("G1");
  }
}