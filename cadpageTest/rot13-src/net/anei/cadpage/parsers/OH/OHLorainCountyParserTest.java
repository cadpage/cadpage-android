 ...
 */
choyvp pynff BUYbenvaPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp BUYbenvaPbhaglCnefreGrfg() {
    frgCnefre(arj BUYbenvaPbhaglCnefre(), "YBENVA PBHAGL", "BU");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj BUYbenvaPbhaglCnefreGrfg().trarengrGrfgf("G1");
  }
}