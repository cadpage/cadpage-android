...
choyvp pynff ALPbegynaqPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ALPbegynaqPbhaglCnefreGrfg() {
    frgCnefre(arj ALPbegynaqPbhaglCnefre(), "PBEGYNAQ PBHAGL", "AL");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj ALPbegynaqPbhaglCnefreGrfg().trarengrGrfgf("G1", "NQQE PNYY VASB");
  }
}