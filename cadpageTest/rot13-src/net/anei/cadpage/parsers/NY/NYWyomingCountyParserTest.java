...
choyvp pynff ALJlbzvatPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ALJlbzvatPbhaglCnefreGrfg() {
    frgCnefre(arj ALJlbzvatPbhaglCnefre(), "JLBZVAT PBHAGL", "AL");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        ...
        "NQQE:90 XREA EQ",
        "PVGL:ORAAVATGBA",
        "K:REVR PB YVAR & HES EQ",
        "VASB:NQHYG SZY ABG SRRYVAT JRYY");
    ...
    qbGrfg("G6",
        ...
        "NQQE:1649 EBHGR 238",
        "PVGL:NGGVPN",
        "K:ARFOVGG EQ & NGGVPN GBJA YVAR");

    qbGrfg("G7",
        "FVPX CREFBA\a1258 OHEEBHTU EQ ORAG (Orgjrra EBHGR 354 & FPUBRYYXBCS EQ)Cbfg fhetvpny noqbzvany cnva.",
        "PNYY:FVPX CREFBA",
        "NQQE:1258 OHEEBHTU EQ",
        "PVGL:ORAAVATGBA",
        "K:EBHGR 354 & FPUBRYYXBCS EQ",
        "VASB:Cbfg fhetvpny noqbzvany cnva.");
   
  }
  
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj ALJlbzvatPbhaglCnefreGrfg().trarengrGrfgf("G1", "PNYY NQQE NCG PVGL K VASB");
  }
}