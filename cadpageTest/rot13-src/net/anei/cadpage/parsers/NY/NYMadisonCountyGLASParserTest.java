...
choyvp pynff ALZnqvfbaPbhaglTYNFCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ALZnqvfbaPbhaglTYNFCnefreGrfg() {
    frgCnefre(arj ALZnqvfbaPbhaglTYNFCnefre(), "ZNQVFBA PBHAGL", "AL");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G3",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\aFHOW:Terngre Yrabk\aZFT:Urneg Ceboyrz\a@ZNQVFBA PBHAGL QFF (133 ABEGU PBHEG FG (JNZCFIVYYR IVY",
        "PNYY:Urneg Ceboyrz",
        "CYNPR:ZNQVFBA PBHAGL QFF",
        "NQQE:133 ABEGU PBHEG FG",
        "PVGL:JNZCFIVYYR");
    ...
    qbGrfg("G6",
        ...
        "PNYY:Purfg Cnva",
        "NQQE:123 PNLHTN NI",
        "ZNQQE:123 PNLHTN NIR",
        "PVGL:FHYYVINA",
        "K:BARVQN YNXR NI / EBHGR 31");

    qbGrfg("G7",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\aFHOW:Terngre Yrabk\aZFT:Fvpx Crefba\a7885 GNPXNOHEL EQ , YRABK ( QVGPU ONAX EQ / VAQVNA BCRAVAT EQ)",
        "PNYY:Fvpx Crefba",
        "NQQE:7885 GNPXNOHEL EQ",
        "PVGL:YRABK",
        "K:QVGPU ONAX EQ / VAQVNA BCRAVAT EQ");

    qbGrfg("G8",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\aFHOW:Terngre Yrabk\aZFT: Purfg Cnva\a3881 PBGGBAF EQ , YVAPBYA ( PYBPXIVYYR EQ / ARYFBA EQ)",
        "PNYY:Purfg Cnva",
        "NQQE:3881 PBGGBAF EQ",
        "PVGL:YVAPBYA",
        "K:PYBPXIVYYR EQ / ARYFBA EQ");
    ...
    qbGrfg("G12",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\aFHOW:Terngre Yrabk\aZFT:ZIN - Crefbany Vawhel\a5050 OHEYRFBA EQ , YVAPBYA ( IRQQRE EQ / SBERFG NI)",
        "PNYY:ZIN - Crefbany Vawhel",
        "NQQE:5050 OHEYRFBA EQ",
        "PVGL:YVAPBYA",
        "K:IRQQRE EQ / SBERFG NI");
    ...
    qbGrfg("G16",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\aFHOW:Terngre Yrabk\aZFT:Purfg Cnva\a@GUREZBYQ & EZU PBECBENGVBA (7059 UNEC EQ (YRABK) )",
        "PNYY:Purfg Cnva",
        "CYNPR:GUREZBYQ & EZU PBECBENGVBA",
        "NQQE:7059 UNEC EQ",
        "PVGL:YRABK");
    ...
    qbGrfg("G17",
        ...
        "ZFT:Genhzngvp Vawhevrf\a" +
        "@FPUBBY PNANFGBGN EBOREGF FG WE FE UVTU FPUBBY (302 EBOREGF FG (PNANFGBGN IVYYNTR) )",

        "PNYY:Genhzngvp Vawhevrf",
        "CYNPR:FPUBBY PNANFGBGN EBOREGF FG WE FE UVTU FPUBBY",
        "NQQE:302 EBOREGF FG",
        "PVGL:PNANFGBGN");
    ...
    qbGrfg("G18",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\a" +
        "FHOW:Terngre Yrabk\a" +
        "ZFT:Cflpuvngevp/Fhvpvqr Nggrzcg\e\a" +
        "403 F CRGREOBEB , PNANFGBGN IVYYNTR ( / ENFONPU)",

        "PNYY:Cflpuvngevp/Fhvpvqr Nggrzcg",
        "NQQE:403 F CRGREOBEB",
        "PVGL:PNANFGBGN",
        "K:ENFONPU");
    ...
    qbGrfg("G19",
        ...
        "NQQE:206 OEBNQ",
        "PVGL:BARVQN PVGL",
        "K:JNFUVATGBA NI / YRABK NI");

    qbGrfg("G20",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\aFHOW:Terngre Yrabk\aZFT:ZIN - Haxabja\e\aEBHGR 31 \\ ZBEEVF EQ (, YRABK)",
        "PNYY:ZIN - Haxabja",
        "NQQE:EBHGR 31 & ZBEEVF EQ",
        "PVGL:YRABK");

    qbGrfg("G21",
        "SEZ:zrffntvat@vnzerfcbaqvat.pbz\aFHOW:Terngre Yrabk\aZFT:ZIN - Crefbany Vawhel\e\aBKOBJ EQ \\ JUVGZNA EQ (, YVAPBYA)",
        "PNYY:ZIN - Crefbany Vawhel",
        "NQQE:BKOBJ EQ & JUVGZNA EQ",
        "PVGL:YVAPBYA");

    qbGrfg("G22",
        "{Terngre Yrabk} \a\aFgebxr/PIN\a\a3021 FRARPN GEACX , YRABK ( UNEC EQ / FHGUREYNAQ QE)",
        "PNYY:Fgebxr/PIN",
        "NQQE:3021 FRARPN GEACX",
        "PVGL:YRABK",
        "K:UNEC EQ / FHGUREYNAQ QE");
  ...
  choyvp ibvq grfgXlyrPnfury() {
    ...
    qbGrfg("G4",
        ...
        "ZNQQE:R PNANY & PYNEX",
        "PVGL:PNANFGBGN",
        "K:PYNEX/YRYNAQ T JEVTUG NI",
        "PNYY:Grfg Pnyy");

    qbGrfg("G5",
        "{Terngre Yrabk}Nqqerff: 3055 JRYYRE GE YRABK-Y22 ; 3055=20\aErfcbafr Glcr: Hapbafpvbhf/Snvagvat=20\a  TYNF Qvfcngpu\a",
        "NQQE:3055 JRYYRE GE (Y22)",
        "ZNQQE:3055 JRYYRE GE",
        "PVGL:YRABK",
        "PNYY:Hapbafpvbhf/Snvagvat");

    qbGrfg("G6",
        "{Terngre Yrabk}Nqqerff: 109 RYZ JNZCFIVYYR IVYYNTR PVGGL YA/J RYZ FG BARVQN JNZCFIVYYR YVAR ; 109=20\a" +
        "Erfcbafr Glcr: Urneg Ceboyrz=20\a" +
        "  TYNF Qvfcngpu\a",
    ...
    qbGrfg("G8",
        "{Terngre Yrabk}Nqqerff: 125 ONEYBJ OHPX/ ; 125 \a\aErfcbafr Glcr: Fvpx Crefba \a\a  TYNF Qvfcngpu\a\a",
        "NQQE:125 ONEYBJ OHPX &",
        "ZNQQE:125 ONEYBJ OHPX",
        "PNYY:Fvpx Crefba");

    qbGrfg("G9",
        "{Terngre Yrabk}Nqqerff: 108 QVNZBAQ PNANFGBGN IVYYNTR R PNANY/PUNCRY,R PUNCRY,A CRGREOBEB,A CRGREOBEB=20\a" +
        "Erfcbafr Glcr: Cflpuvngvp/Fhvpvqr=20\a" +
        "  TYNF Qvfcngpu",
  ...
  choyvp ibvq grfgXlyrPnfury3() {
    ...
    qbGrfg("G10",
        "{Terngre Yrabk}\aPurfg Cnva\a\aErasre, Wbua & Pbafgnapr 7814 YNXRCBEG EQ, FHYYVINA ( PURFGAHG EVQTR EQ )",
        "PNYY:Purfg Cnva",
        "ANZR:Erasre, Wbua & Pbafgnapr",
        "NQQE:7814 YNXRCBEG EQ",
        "PVGL:FHYYVINA",
        "K:PURFGAHG EVQTR EQ");
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj ALZnqvfbaPbhaglTYNFCnefreGrfg().trarengrGrfgf("G1");
  }
}