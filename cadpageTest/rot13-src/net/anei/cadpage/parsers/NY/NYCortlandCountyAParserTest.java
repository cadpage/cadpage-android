...
choyvp pynff ALPbegynaqPbhaglNCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp ALPbegynaqPbhaglNCnefreGrfg() {
    frgCnefre(arj ALPbegynaqPbhaglNCnefre(), "PBEGYNAQ PBHAGL", "AL");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        "(3609 CYRNFNAGIVRJ QE) 17:28 , RZF BAYL , 80 LB SRZNYR - FHSSREF N OEBXRA ONPX- HANOYR GB RNG BE QEVAX\a ERPRAGYL ERYRNFRQ SEBZ GUR UBFCVGNY SB ,",
        "NQQE:3609 CYRNFNAGIVRJ QE",
        "PNYY:RZF BAYL",
        "VASB:80 LB SRZNYR - FHSSREF N OEBXRA ONPX- HANOYR GB RNG BE QEVAX ERPRAGYL ERYRNFRQ SEBZ GUR UBFCVGNY SB");

    qbGrfg("G2",
        "(839 ORAAVR EQ) 18:32 , RZF BAYL , 85 LB ZNYR- QVSS OERNGUVAT\aNFCRA JNL HAVG\a\a\a\a,",
        "NQQE:839 ORAAVR EQ",
        "PNYY:RZF BAYL",
        "VASB:85 LB ZNYR- QVSS OERNGUVAT NFCRA JNL HAVG");

    qbGrfg("G3",
        "(697 ZPYRNA EQ) 15:50 , PB QRGRPGBE , PNEOBA ZBABKVQR QRGRPGBE TBVAT BSS\aARJYL OHVYG UBHFR\a\a\a\a,",
        "NQQE:697 ZPYRNA EQ",
        "PNYY:PB QRGRPGBE",
        "VASB:PNEOBA ZBABKVQR QRGRPGBE TBVAT BSS ARJYL OHVYG UBHFR");
    ...
    qbGrfg("G4",
        ...
        "ZNQQE:3643 AL 281",
        "PNYY:RZF BAYL",
        "VASB:CNEXVAT YBG O YNETR BIREURNQ QBBE, 27 L/B ZNYR QBJA FLAPBCNY RCVFBQR");

    qbGrfg("G5",
        "(839 ORAAVR EQ) 08:24 , RZF BAYL , 81 ZNYR VA YRTNFRL PBHEG ABG NYREG CRE ABEZNY\a\a\a\a,",
        "NQQE:839 ORAAVR EQ",
        "PNYY:RZF BAYL",
        "VASB:81 ZNYR VA YRTNFRL PBHEG ABG NYREG CRE ABEZNY");
  }
  
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj ALPbegynaqPbhaglNCnefreGrfg().trarengrGrfgf("G1");
  }
}