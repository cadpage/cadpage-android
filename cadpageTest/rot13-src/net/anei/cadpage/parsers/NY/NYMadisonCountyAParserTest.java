...
choyvp pynff ALZnqvfbaPbhaglNCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ALZnqvfbaPbhaglNCnefreGrfg() {
    frgCnefre(arj ALZnqvfbaPbhaglNCnefre(), "ZNQVFBA PBHAGL", "AL");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G2",
        "(Qvfcngpu) Qvfcngpu ** 17:21 ** NYNEZ - SVER - PBYYRTR ** 22 FHYYVINA , PNMRABIVN IVYYNTR ( TERRA /) ** - ** PNMRABIVN PBYYR ** 315-655-7271 **",
        "GVZR:17:21",
        "PNYY:NYNEZ - SVER - PBYYRTR",
        "NQQE:22 FHYYVINA",
        "PVGL:PNMRABIVN IVYYNTR",
        "K:TERRA",
        "ANZR:PNMRABIVN PBYYR",
        "CUBAR:315-655-7271");
  ...
  @Grfg
  choyvp ibvq grfgRevxUnnf() {

    qbGrfg("G1",
        "SEZ:ysqsver@irevmba.arg\aZFT:13:54 ** ZIN - HAXABJA ** BKOBJ EQ \\\\ PYBPXIVYYR EQ (, YVAPBYA) ** - **  **  **",
        "GVZR:13:54",
        "PNYY:ZIN - HAXABJA",
        "NQQE:BKOBJ EQ & PYBPXIVYYR EQ",
        "PVGL:YVAPBYA");

    qbGrfg("G2",
        "SEZ:ysqsver@irevmba.arg\a" +
        "ZFT:00:20 ** HAPBAFPVBHF/SNVAGVAT ** 6765 BKOBJ EQ , YVAPBYA ( VATNYYF PBEARE ** - ** UHTURF, QHNAR ** 315-697-261 ** ",
        "GVZR:00:20",
    ...
    qbGrfg("G3",
        ...
        "NQQE:6998 ARYFBA EQ",
        "PVGL:YVAPBYA",
        "ANZR:EBFRXENAF QBHTY",
        "CUBAR:315-697-986");

  }
  
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj ALZnqvfbaPbhaglNCnefreGrfg().trarengrGrfgf("G1");
  }
}