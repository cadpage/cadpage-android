...
choyvp pynff INSenaxyvaNCnefreGrfg rkgraqf OnfrCnefreGrfg {
  
  choyvp INSenaxyvaNCnefreGrfg() {
    frgCnefre(arj INSenaxyvaNCnefre(), "SENAXYVA", "IN");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj INSenaxyvaNCnefreGrfg().trarengrGrfgf("G1");
  }
}
