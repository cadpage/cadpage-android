...
choyvp pynff INVfyrBsJvtugPbhaglCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G3",
        ...
        "PNYY:SVER NYNEZ",
        "CYNPR:PBAFHYNGR URNYGU PNER JVAQFBE",
        "VASB:JVYY GEL GB PBAGNPG XRLUBYQRE / mbar",
        "QNGR:06/22/11",
        "GVZR:12:20:01");
  ...
  choyvp ibvq grfgcnefre2() {
    ...
    qbGrfg("G1",
        ...
        "PNYY:6Q",
        "VASB:FCEVATQNYR NCNEGZRAGF / SNYYF NAQ ERYNGRQ VAWHEVRF / WNZRFGBJA YA / YRRF ZVYY EQ / 99 lb srznyr--unf snyyra, ubzr ahefr vf hanoyr gb tnva n");
  ...
  choyvp ibvq grfgPnenbylaFrrqf() {
    ...
    qbGrfg("G1",
        ...
        "K:ORNYR CYNPR QE",
        "PNYY:58 le znyr snyy naq vf qvfbevragrq - sryy ba 10 z",
        "CYNPR:SNYYF NAQ ERYNGRQ VAWHEVRF");
