...
choyvp pynff JVXrabfunPbhaglOCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp JVXrabfunPbhaglOCnefreGrfg() {
    frgCnefre(arj JVXrabfunPbhaglOCnefre(), "XRABFUN PBHAGL", "JV");
  }
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj JVXrabfunPbhaglOCnefreGrfg().trarengrGrfgf("G1");
  }
}