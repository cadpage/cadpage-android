...
public class JulianDateTest {
  ...
  @Test
  public void testValidUntilTime() throws ParseException {
    doValidTimeTest("T1", "05/26/2013 21:48:07", "05/27/2013 00:00:00");
  }
  
  private void doValidTimeTest(String title, String curTime, String expValidTime) throws ParseException {
    JulianDate curJDate = new JulianDate(DATE_TIME_FMT.parse(curTime));
    long validTime = curJDate.validUntilTime();
    assertEquals(title, expValidTime, DATE_TIME_FMT.format(new Date(validTime)));
