...
public class ALChiltonCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T2",
        ...
        "MADDR:COUNTY ROAD 57 & COUNTY ROAD 445",
        "ID:2011039172",
        "TIME:06:20:45",
    ...
    doTest("T7",
        ...
        "MADDR:905 COUNTY ROAD 402",
        "CITY:CLANTON",
        "ID:2011050250",
        "TIME:05:43:58",
        "CALL:GENERAL ILLNESS 57 YO FEMALE",
        "INFO:NERVE PROBLEMS // PERMENANT NERVE DAMAGE //");

    doTest("T8",
        "  / 3669 COUNTY RD 49 CLANTON 2011052209 11:18:28 FALL ELDERLY MALE FELL\n",
        "ADDR:3669 COUNTY RD 49",
        "MADDR:3669 COUNTY ROAD 49",
        "CITY:CLANTON",
        "ID:2011052209",
        "TIME:11:18:28",
  ...
  public static void main(String[] args) {
    new ALChiltonCountyParserTest().generateTests("T1");
  }
}