...
- E911 Notification - Elberta VFD - 04-29-13 20:36: Station STA31 dispatched to Incident ID 416064 (Smell Smoke) at 12400 DEER ACRE

Sender: noreply@emergencycallworx.com
- E911 Notification - Elberta VFD - 12-08-12 09:46: Station STA31 dispatched to Incident ID 365515 (Auto Accident) at JO
- E911 Notification - Elberta VFD - 07-16-13 06:34: Station STA31 dispatched to Incident ID 447382 (Auto Accident) at 87 NORTH OF WILLOW RIDGE\n
...
public class ALBaldwinCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T8",
        ...
        "ID:447382",
        "CALL:Auto Accident",
        "ADDR:87 NORTH OF WILLOW RIDGE",
        "MADDR:87 & WILLOW RIDGE");
  ...
  public static void main(String[] args) {
    new ALBaldwinCountyParserTest().generateTests("T1");
  }
}