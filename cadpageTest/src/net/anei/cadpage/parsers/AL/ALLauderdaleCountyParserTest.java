...
Contact: Roy Nagle <ranagle58@gmail.com>
Sender: 911paging
1 of 2\nFRM:911paging \nSUBJ:IPS I/Page\nMSG:PRI: GHVFD AD: 13055 COUNTY RD 47 CNTY  TIME: 08:50:53 EV: MD-BREATHING -: default CS1: COUNTY RD 38\n(Con't) 2 of 2\nCS2: COUNTY RD 38 RE:  63/M CANT BREATH \n(End)
1 of 2\nFRM:911paging \nSUBJ:IPS I/Page\nMSG:PRI: GHVFD AD: 7425 COUNTY RD 25 CNTYTIME: 12:02:41 EV: FIRE-BRUSH -: default CS1: COUNTY RD 386\n(Con't) 2 of 2\nCS2: PRIVATE DRIVE RE:ALT# 256-443-3883 -087.544169 +34.975694 CALLER REPORTING BRUSH FIRE \n(End)
...
public class ALLauderdaleCountyParserTest extends BaseParserTest {
  ...
  public void testRoyNagle() {
    ...
    doTest("T1",
        ...
        "SRC:GHVFD",
        "ADDR:13055 COUNTY RD 47",
        "MADDR:13055 COUNTY ROAD 47",
        "CALL:MD-BREATHING - default",
        "X:COUNTY RD 38 & COUNTY RD 38",
        "INFO:63/M CANT BREATH");
    ...
    doTest("T2",
        ...
        "SRC:GHVFD",
        "ADDR:7425 COUNTY RD 25",
        "MADDR:7425 COUNTY ROAD 25",
        "CALL:FIRE-BRUSH - default",
        "X:COUNTY RD 386 & PRIVATE DRIVE",
        "PHONE:256-443-3883",
        "GPS:+34.975694,-87.544169",
        "INFO:CALLER REPORTING BRUSH FIRE");
