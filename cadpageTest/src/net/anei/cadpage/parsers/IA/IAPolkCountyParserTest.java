...
Contact: "Evan M. Kellis" <KellisEM@crnci.com>
Sedner: messaging@iamresponding.com
Subject:DEFD\nType: RESCUE PIA Caller: VERIZON Time: 05:41:17
Subject:DEFD\nLocation: 6930 NE 56TH ST DELA,54: @COUNTRY LIVING MOBILE HOME PARK - DELA Type: INVESTIGATION CO Caller: STUART,CINDY
...
public class IAPolkCountyParserTest extends BaseParserTest {
  ...
  public void testEvanKellis() {
    ...
    doTest("T2",
        ...
        "SRC:DEFD",
        "ADDR:6930 NE 56TH ST",
        "APT:54",
        "CITY:DELAWARE TWP",
        "CALL:INVESTIGATION CO",
        "PLACE:COUNTRY LIVING MOBILE HOME PARK - DELA / STUART,CINDY");
