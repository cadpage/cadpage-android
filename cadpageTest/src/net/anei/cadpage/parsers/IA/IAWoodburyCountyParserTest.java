...
J:LIFELINE/945 WYNSTONE RD UNION COUNTY/NSIOUX/ 72EMS9/UNKN PER 621  NOTHING FURTHER AT THIS TIME
J:HEART PROBLEMS/345 W STEAMBOAT DR DAKOTA DUNES FAMILY HEALTH CARE DAKOTA DUNE/DDUNES/ 72EMS9/Using ProQA Medical
...
public class IAWoodburyCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T9",
        "J:LIFELINE/945 WYNSTONE RD UNION COUNTY/NSIOUX/ 72EMS9/UNKN PER 621  NOTHING FURTHER AT THIS TIME",
        "CALL:LIFELINE",
        "ADDR:945 WYNSTONE RD",
        "CITY:UNION COUNTY",
        "ST:SD",
        "SRC:NSIOUX",
        "UNIT:72EMS9",
        "INFO:UNKN PER 621  NOTHING FURTHER AT THIS TIME");

    doTest("T10",
        "J:HEART PROBLEMS/345 W STEAMBOAT DR DAKOTA DUNES FAMILY HEALTH CARE DAKOTA DUNE/DDUNES/ 72EMS9/Using ProQA Medical",
        "CALL:HEART PROBLEMS",
        "ADDR:345 W STEAMBOAT DR",
        "CITY:DAKOTA DUNES",
        "PLACE:FAMILY HEALTH CARE DAKOTA DUNE",
        "ST:SD",
        "SRC:DDUNES",
        "UNIT:72EMS9",
  ...
  public static void main(String[] args) {
    new IAWoodburyCountyParserTest().generateTests("T1");
  }
}