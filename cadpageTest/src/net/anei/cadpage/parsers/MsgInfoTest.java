...
public class MsgInfoTest {
  ...
  public void testGetMapAddress() {
    ...
    doMapTest("ILMcHenryCounty", "12300 S ROUTE 47,KENBURG,XX", "12300 S ROUTE 47 HY");
    
    doMapTest("COKitCarsonCounty", "COUNTY ROAD 46 & COUNTY ROAD U,KENBURG,XX", "CR 46 AND CR U");
    
    doMapTest("COKitCarsonCounty", "48275 COUNTY ROAD HH,KENBURG,XX", "48275 CR HH");
    
    doMapTest("MOJohnsonCounty", "NE HWY FF & NE HWY 50,KENBURG,XX", "NE FF HWY & NE 50 HWY");
    
    doMapTest("NYStLawrenceCounty", "5771 COUNTY ROAD 10,KENBURG,XX", "5771 CO RT 10");
    
    doMapTest("ZCAONMississauga", "401EB & HURONTARIO ST TO HWY 410,KENBURG,XX", "401EB E OF HURONTARIO ST TO HWY410");
    
    doMapTest("Unknown", "767 E RT 70,KENBURG,XX", "767 E RT70");
    ...
    doMapTest("BND1", "US 85 & E 77TH AVE,KENBURG,XX", "US HIGHWAY 85 NB & E 77TH AVE");
    doMapTest("BND2", "US 100,KENBURG,XX", "US HIGHWAY 100 SB");
  ...
  private void doMapTest(String title, String result, String address, 
    ...
    assertEquals(title, result, info.getMapAddress(2, null, null));
  }
}
