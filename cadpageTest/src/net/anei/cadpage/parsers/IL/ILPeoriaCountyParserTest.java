...
public class ILPeoriaCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T2",
        ...
        "ID:20200",
        "X:W MC DONALD RD 84",
        "INFO:YOM CARRYING SOMETHING IN GARAGE, FELL BACKWARD, HIT HEAD ON CONCRETE, C / A / B OK");
    ...
    doTest("T3",
        ...
        "CITY:HANNA CITY",
        "ID:600",
        "X:N PEKIN LN 82 YO MALE FELL HAS HEAD AND HIP INJ NO",
        "INFO:BLEEDING");
    ...
    doTest("T11",
        ...
        "CITY:PEORIA COUNTY",
        "ID:4500",
        "X:S TEWKESBURY RD 78YO",
        "INFO:MALE UNRESPONSIVE W / SHALLOW BREATH");
    ...
    doTest("T12",
        ...
        "CITY:PEORIA COUNTY",
        "ID:16300",
        "X:W SMITHVILLE RD 72",
        "INFO:YO MALE JST RELEASED FRM HOSP TODAY FRM BYPASS HAS AN1513,005 INCISION ON CHEST SERIOUS BLEEDING HAS SOAKED THRU TSHIRT1513,005 C / A / B OK RIGHT NOW");
