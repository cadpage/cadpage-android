...
Contact: Dalton Carlson <dacarlson12@gmail.com>
Sender: firepage@peoriagov.org
03/19/13 { 1900}E ST JUDE CT Jr=PH :( 5700) N GALENA RD 3PTY WOODFORD ACC INJ UNK 1726,007
...
public class ILPeoriaCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T5",
        "12/28/10 {10301}W LANCASTER RD CO :( 5500) S HARKERS CORNER RD ROLL OVER 1300,006",
        "DATE:12/28/10",
        "ADDR:W LANCASTER RD & S HARKERS CORNER RD",
        "CITY:PEORIA COUNTY",
        "INFO:ROLL OVER",
        "TIME:13:00",
        "UNIT:006");
  ...
  @Test
  public void testDoltonCarlson() {

    doTest("T1",
        "03/19/13 { 1900}E ST JUDE CT Jr=PH :( 5700) N GALENA RD 3PTY WOODFORD ACC INJ UNK 1726,007",
        "DATE:03/19/13",
        "ADDR:E ST JUDE CT & N GALENA RD",
        "CITY:PEORIA HEIGHTS",
        "INFO:3PTY WOODFORD ACC INJ UNK",
        "TIME:17:26",
        "UNIT:007");
  ...
  public static void main(String[] args) {
    new ILPeoriaCountyParserTest().generateTests("T1");
  }
}