...
public class ILMedstarParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T7",
        ...
        "MADDR:IN PATIENT,St Elizabeths B'vll",
        "PLACE:IN PATIENT",
        "APT:347-2",
        "MAP:26",
        "CITY:BELLEVILLE",
  ...
  public void testActive911A() {
    ...
    doTest("T6",
        ...
        "MADDR:ER DEPT,Red Bud Regional Hosp",
        "APT:5",
        "PLACE:ER DEPT",
        "CITY:RED BUD",
  ...
  public static void main(String[] args) {
    new ILMedstarParserTest().generateTests("T1", "ID ADDR APT PLACE X MAP CITY CALL INFO");
  }
}