...
1300002345 CHARLIE MEDICAL 00082 ELLIOT ST  Prem Map -3  PP 16 HENRY ST/HOOP POLE LA   R1 E4 130517 09:47
...
Contact: jason lyman <jaslyman@gmail.com>
Sender: paging@nbpolicect.org
  / 1300003606 MEDICAL MEDA 00009  DAVID LN TOMMY'S PATH/DEAD END  514  MED4  130522 18:00
...
public class CTNewHavenCountyBParserTest extends BaseParserTest {
  ...
  public void testEastHaven() {
    ...
    doTest("T8",
        "1300002345 CHARLIE MEDICAL 00082 ELLIOT ST  Prem Map -3  PP 16 HENRY ST/HOOP POLE LA   R1 E4 130517 09:47",
        "ID:1300002345",
        "CALL:CHARLIE MEDICAL",
        "ADDR:82 ELLIOT ST",
        "MAP:3  PP 16",
        "X:HENRY ST/HOOP POLE LA",
        "UNIT:R1 E4",
        "DATE:05/17/13",
        "TIME:09:47");
  ...
  public static void main(String[] args) {
    new CTNewHavenCountyBParserTest().generateTests("T1");
  }
}