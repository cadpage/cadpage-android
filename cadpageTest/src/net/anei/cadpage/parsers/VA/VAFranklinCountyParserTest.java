...
Contact: Bob Makson <bmakson147@gmail.com>
Sender: MAILBOX@franklincountyva.org
MAILBOX:S10 ABDOMINAL PAIN 1074 MALLARD POINT RD WIR CFS# 2013-007724 CROSS: FOREST SHORES RD/SAINT AUGUSTINE RD
...
public class VAFranklinCountyParserTest extends BaseParserTest {
  ...
  @Test
  public void testBobMakson() {

    doTest("T1",
        "MAILBOX:S10 ABDOMINAL PAIN 1074 MALLARD POINT RD WIR CFS# 2013-007724 CROSS: FOREST SHORES RD/SAINT AUGUSTINE RD",
        "SRC:S10",
        "CALL:ABDOMINAL PAIN",
        "ADDR:1074 MALLARD POINT RD",
        "CITY:Wirtz",
        "ID:2013-007724",
        "X:FOREST SHORES RD/SAINT AUGUSTINE RD");
