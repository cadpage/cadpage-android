...
(Nature: 29-MVA - PRE-ALERT) New Fire Run: 2012-26265,,E182,Location: 29603 HIGHLAND BLVD,Building: ,Cross: ,,Grid: 214Y,Map: 4775,.
(Nature: F03-AUTOMATIC ALARM) New Fire Run: 2012-26268,,E186,Location: 10803 CLUBHOUSE CIR-MA,Building: ,Cross: 2 WINDCREST NATIONAL,Grid: 215J,
(Nature: 19C02-HEART PROBLEMS - Abnormal Breathin) New Fire Run: 2012-26276,,MR18,Location: 18626 N SUGAR MAPLE CIR,Building: ,Cross: ,,Grid: 21
(Nature: 21D03-HEMORRHAGE - Dangerous hemorrhage) New Fire Run: 2012-26291,,MR18,Location: 16110 BEAVER LN,Building: ,Cross: ,,Grid: 246T,Map: 4
...
public class TXMontgomeryCountyAParserTest extends BaseParserTest {
  
  public TXMontgomeryCountyAParserTest() {
    setParser(new TXMontgomeryCountyAParser(), "MONTGOMERY COUNTY", "TX");
  }
  ...
  public void testParser() {
    ...
    doTest("T33",
        ...
        "CALL:F03-AUTOMATIC ALARM",
        "UNIT:E186",
        "ADDR:10803 CLUBHOUSE CIR",
        "CITY:MAGNOLIA",
        "X:2 WINDCREST NATIONAL",
        "MAP:215J");

    doTest("T34",
        "(Nature: 19C02-HEART PROBLEMS - Abnormal Breathin) New Fire Run: 2012-26276,,MR18,Location: 18626 N SUGAR MAPLE CIR,Building: ,Cross: ,,Grid: 21",
        "ID:2012-26276",
        "CALL:19C02-HEART PROBLEMS - Abnormal Breathin",
        "UNIT:MR18",
        "ADDR:18626 N SUGAR MAPLE CIR",
        "MAP:21");

    doTest("T35",
        "(Nature: 21D03-HEMORRHAGE - Dangerous hemorrhage) New Fire Run: 2012-26291,,MR18,Location: 16110 BEAVER LN,Building: ,Cross: ,,Grid: 246T,Map: 4",
        "ID:2012-26291",
        "CALL:21D03-HEMORRHAGE - Dangerous hemorrhage",
        "UNIT:MR18",
        "ADDR:16110 BEAVER LN",
        "MAP:246T-4");
  }
  ...
  public static void main(String[] args) {
    new TXMontgomeryCountyAParserTest().generateTests("T1");
  }
}
