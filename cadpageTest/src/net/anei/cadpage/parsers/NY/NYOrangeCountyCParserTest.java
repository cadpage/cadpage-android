...
public class NYOrangeCountyCParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T5",
        ...
        "CITY:MONTGOMERY",
        "INFO:1 ENG STBY MONTGOMERY INCIDENT CLONED FROM",
        "ID:F29120531000398",
    ...
    doTest("T7",
        ...
        "MADDR:2040 NY 208",
        "CITY:MONTGOMERY",
        "INFO:TRACTOR TRAILER ROLLOVER - WITH PIN SiblingInc MMO120601003179",
        "X:2 MORRISON PL /2 HOUSTON PL");
    ...
    doTest("T8",
        ...
        "CITY:MONTGOMERY",
        "INFO:1 ENGINE OWN QTRS INCIDENT CLONED FROM",
        "ID:F29120601000402",
    ...
    doTest("T10",
        ...
        "CITY:HAMPTONBURGH",
        "INFO:STDBY IN QTRS FOR DEPT 2 INCIDENT CLONED FROM",
        "ID:F02120602000223");
    ...
    doTest("T13",
        ...
        "CITY:MONTGOMERY",
        "INFO:EASTBOUND///TRACTOR TRAILER VS CAR UNK PI",
        "ID:MMG120606000931");
