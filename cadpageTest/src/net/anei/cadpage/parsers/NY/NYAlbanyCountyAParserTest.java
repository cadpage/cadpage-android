...
Contact: harv bender <harvb70@gmail.com>
Sender: biance@colonie.org
BREATHING PROBLEMS/DIFF SPEAKING BETWEEN BREATHS A652,SQ6\n800 N PEARL ST #NYS-DEPT-OF-CORRECTIONAL\nNYS DEPT CORRECTIONAL SERVICES\nMap MENANDS 11:12:35
...
public class NYAlbanyCountyAParserTest extends BaseParserTest {
  ...
  public void testHarvBender() {
    ...
    doTest("T1",
        ...
        "CALL:BREATHING PROBLEMS/DIFF SPEAKING BETWEEN BREATHS",
        "UNIT:A652,SQ6",
        "ADDR:800 N PEARL ST",
        "APT:NYS-DEPT-OF-CORRECTIONAL",
        "PLACE:NYS DEPT CORRECTIONAL SERVICES",
        "MAP:MENANDS",
        "TIME:11:12:35");
