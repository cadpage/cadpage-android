...
public class NYNassauCountyParserTest {
  ...
  public static class TestG extends NYNassauCountyGParserTest {
    public TestG() {
      setParser(new NYNassauCountyParser());
    }
  }
  
  public static class TestH extends NYNassauCountyHParserTest {
    public TestH() {
      setParser(new NYNassauCountyParser());
    }
  }
  
  public static class TestI extends NYNassauCountyIParserTest {
    public TestI() {
      setParser(new NYNassauCountyParser());
    }
  }
