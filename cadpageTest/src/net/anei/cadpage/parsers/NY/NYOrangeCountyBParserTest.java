...
Contact: George Padgett <gpadgett269@gmail.com>
...
DEPT38     TYP: SMOKE INVESTIGATION AD: 4 WRIGHT ST CTY: PORT JERVIS CN: BISHOP, CAROL L CMT1: CALLER SEES SMOKE AND SMELLS BURNING WOOD//POSSIBLY FROM BE

Orange County, NY (replace 1 of the 4??)
Contact: Bob Quackenbush <rdquackenbush@cvfd-fire.org>
Sender: messaging@iamresponding.com
1 of 3\nFRM:messaging@iamresponding.com\nSUBJ:Cronomer Valley\nMSG:INC: F09121115000892 TYP: ANNOUNCEMENT AD: 296 N PLANK RD CTY: NEWBURGH CN: 09C2\n(Con't) 2 of 3\nCMT1: ANY MEMBERS AVAIL FOR A DEPLOYMENT TO NASSUA CO FRI MORN TO CONTACT CAR2 CMT2: BY CELL TIME: 18:21 XST: 1 BERRY LN XST2: 1 WEYANTS\n(Con't) 3 of 3\nLN\n\n\nThis message has been scanned for malware.\n\n(End)

Contact: John Sposato <johnspocfd221@gmail.com>
Sender: @oc911.smartmsg.com
(OC911 ALERT) INC: F04130121000097 TYP: ANNOUNCEMENT AD: 712 LAKES RD CTY: CHESTER CN: 4-1 CMT1: E914 OOS FOR REPAIRS CMT2: Original Location : T
(OC911 ALERT) INC: F04130121000100 TYP: ANNOUNCEMENT AD: 1408 KINGS HWY CTY: CHESTER CMT1: E914 BACK IN SERVICE CMT2: Original Location : SUGARLO
(OC911 ALERT) INC: F04130122000105 TYP: ANNOUNCEMENT AD: 1408 KINGS HWY CTY: CHESTER CN: 04C1 CMT1: TA919 OOS FOR REPAIRS CMT2: Original Location
...
public class NYOrangeCountyBParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T28",
        ...
        "CITY:WARWICK",
        "NAME:ELMER BUDD",
        "INFO:HAVE WARWICK DUTY CHIEF CALL GOSHEN 3 ASAP",
        "PLACE:EXCELSI");
    ...
    doTest("T29",
        ...
        "CITY:CHESTER",
        "NAME:BILL PETRICK",
        "INFO:T917 IS BACK IN SERVICE AND RELEASE WARWICK WITH THEIR THANKS");
    ...
    doTest("T30",
        ...
        "CITY:PORT JERVIS",
        "NAME:BISHOP, CAROL L",
        "INFO:CALLER SEES SMOKE AND SMELLS BURNING WOOD//POSSIBLY FROM BE");
  ...
  public void testParser2() {
    ...
    doTest("T1",
        ...
        "CITY:NEWBURGH",
        "NAME:09C2",
        "INFO:ANY MEMBERS AVAIL FOR A DEPLOYMENT TO NASSUA CO FRI MORN TO CONTACT CAR2 / BY CELL",
        "TIME:18:21",
        "X:1 BERRY LN & 1 WEYANTS LN");

  }
  
  @Test
  public void testJohnSposato() {
