...
Contact: joe@jwfoxjr.com
Sender: +12145665304
USMO SMS: ASSISTANCE-FIRST AID 2348 BERG RD WEST SENECA 5 DAY OLD CHILD CHOKING.  <NOREPLY>
...
public class NYErieCountyCParserTest extends BaseParserTest {
  ...
  public void testJoe() {
    ...
    doTest("T1",
        "USMO SMS: ASSISTANCE-FIRST AID 2348 BERG RD WEST SENECA 5 DAY OLD CHILD CHOKING.  <NOREPLY>",
        "CALL:ASSISTANCE-FIRST AID",
        "ADDR:2348 BERG RD",
        "INFO:WEST SENECA 5 DAY OLD CHILD CHOKING");

  }
  
  public static void main(String[] args) {
    new NYErieCountyCParserTest().generateTests("T1");
  }
}