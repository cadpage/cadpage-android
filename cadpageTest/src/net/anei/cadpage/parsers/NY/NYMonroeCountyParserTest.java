...
public class NYMonroeCountyParserTest extends BaseParserTest {
  
  public NYMonroeCountyParserTest() {
    setParser(new NYMonroeCountyParser(), "MONROE COUNTY", "NY");
  }
  ...
  public static void main(String[] args) {
    new NYMonroeCountyParserTest().generateTests("T1");
  }
}