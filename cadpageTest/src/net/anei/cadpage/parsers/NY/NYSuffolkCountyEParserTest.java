...
public class NYSuffolkCountyEParserTest extends BaseParserTest {
  ...
  public void testParser2() {
    ...
    doTest("T3",
        ...
        "PLACE:178",
        "ADDR:PECONIC BAY BLVD",
        "MADDR:178,PECONIC BAY BLVD",
        "CITY:AQUEBOGUE",
  ...
  public void testJimLull() {
    ...
    doTest("T13",
        ...
        "PLACE:TRAILER PARK",
        "ADDR:RIVER RD",
        "MADDR:TRAILER PARK,RIVER RD",
        "APT:1ST",
        "INFO:TRAILER ON RIGHT HAND SIDE POSSIBLE HEART");

    doTest("T14",
        "FROM RELAY 1279 EAST MAIN EASTERN CARDIOLOGY MALE CHEST PAINS",
        "ADDR:1279 EAST MAIN EASTERN CARDIOLOGY MALE CHEST PAINS");

    doTest("T15",
        "FROM RELAY TANGER 2 STE 1401 EPIC JEANS 40ISH FEMALE PASSING OUT",
        "PLACE:TANGER",
        "ADDR:2 STE 1401 EPIC JEANS 40ISH FEMALE PASSING OUT");
    ...
    doTest("T18",
        ...
        "ADDR:35 OPEN DRIVE",
        "INFO:ADULT FEMALE SICK");

    doTest("T19",
        "FROM RELAY 1106 WEST MAIN FEMALE DIFFICULTY BREATHING",
        "ADDR:1106 WEST MAIN FEMALE DIFFICULTY BREATHING");

    doTest("T20",
        "FROM RELAY 1145 MIDDLE ROAD APARTMENT 7M ELDERLY FEMALE POSSIBLE HEART",
        "ADDR:1145 MIDDLE ROAD",
        "INFO:APARTMENT 7M ELDERLY FEMALE POSSIBLE HEART");

    doTest("T21",
        "FROM RELAY 1355 ROANOKE AVE APT 8 FEMALE ABDOMINAL",
        "ADDR:1355 ROANOKE AVE",
        "APT:8",
        "INFO:FEMALE ABDOMINAL");

  }
  
  public static void main(String[] args) {
    new NYSuffolkCountyEParserTest().generateTests("T13", "PLACE ADDR APT CITY INFO");
  }
