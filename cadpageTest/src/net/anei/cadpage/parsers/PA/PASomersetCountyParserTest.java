...
Contact: fire61765@yahoo.com <fire61765@yahoo.com>
Sender: 911CENTER@co.somerset.pa.us
(ODOR  >ODOR INVESTIGATION/COMPL) 911CENTER:1534 N CENTER AVE XS: REVCO RD SOMERSET CRAIG STAPLETON 8142893527 Map: Grids:, Cad: 2013-0000004852
...
public class PASomersetCountyParserTest extends BaseParserTest {
  ...
  @Test
  public void testfire61765() {

    doTest("T1",
        "(ODOR  >ODOR INVESTIGATION/COMPL) 911CENTER:1534 N CENTER AVE XS: REVCO RD SOMERSET CRAIG STAPLETON 8142893527 Map: Grids:, Cad: 2013-0000004852",
        "CALL:ODOR INVESTIGATION/COMPL",
        "ADDR:1534 N CENTER AVE",
        "X:REVCO RD",
        "CITY:SOMERSET",
        "NAME:CRAIG STAPLETON",
        "PHONE:8142893527",
        "ID:2013-0000004852");
  ...
  public static void main(String[] args) {
    new PASomersetCountyParserTest().generateTests("T1");
  }
}
