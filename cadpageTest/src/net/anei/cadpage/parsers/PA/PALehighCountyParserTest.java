...
public class PALehighCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T22",
        ...
        "INFO:**BRAVO MVA - WITH INJURIES / Original Location : NORTH OF LOWER MACUNGIE RD",
        "TIME:06:40",
        "UNIT:FD/FP3052");
    ...
    doTest("T26",
        ...
        "SRC:ST1100",
        "CALL:ALARM-FIRE-HIGH OCC",
        "ADDR:768 PARKWAY RD",
        "CITY:SOUTH WHITEHALL TWP",
        "PLACE:PARKWAY MANOR ELEMENTARY",
        "NAME:LEE 62",
        "INFO:**FIRE ALARM - HIGH OCCUPANCY / GENERAL FIRE ALARM - ATTEMPTING KEYHOLDER",
        "TIME:06:12",
    ...
    doTest("T27",
        ...
        "SRC:ST6651",
        "CALL:COMMERCIAL STRUCTURE",
        "ADDR:7000 ALBURTIS RD",
        "CITY:LOWER MACUNGIE TWP",
        "PLACE:MACK TRUCKS",
        "NAME:MICHELLE",
        "INFO:**COMMERCIAL STRUCTURE FIRE / THE BUILDING IS ON FIRE",
        "TIME:12:56",
    ...
    doTest("T29",
        ...
        "SRC:ST3000",
        "CALL:ALARM-CO NO VICTIMS",
        "ADDR:6610 TRAFALGAR DR",
        "CITY:LOWER MACUNGIE TWP",
        "NAME:CARTER RES",
        "INFO:**CARBON MONOXIDE ALARM - NO VICTIM Body:S / CARBON MONOXIDE ALARM SOUNDING NO ONE IS FEELING SICK",
        "TIME:20:28",
        "UNIT:FD/ST30",
