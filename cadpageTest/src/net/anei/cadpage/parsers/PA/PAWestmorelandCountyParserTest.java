...
Contact: Gary Gauker <tazz49.gg@gmail.com>
Sender: alert@ecm2.us
(ST49 - 911 Call) Loc: 4206 ROUTE 66 WASH_T: @GLASSMART X-sts: ROUTE 380 & BEAVER RUN RD  Inc#:F12020572 NATURE: SMOKE SMOKE INVESTIGATION  CALLER: GLASS MART FOOD ST
Loc: 5630 GREENSBURG RD WASH_T X-sts: WASHINGTON RD & SPRING HILL RD  Inc#:F13013216 NATURE: 22B02 INACC INC/PERIPHERAL ENTRAP  CALLER: DON GRICE TOC: 09:42:32 Fire TAC:  EMS Tac: Comments: MALE PINNED BETWEEN TREE AND MACHINE Response text: Bravo Responder script: 47 year old, Male, Conscious, Breathing. Inaccessible Incident / Other Entrapments (Non-Vehicle). 1.This incident does not involve the release of hazardous materials. 2.He is trapped in machinery. 3.The accident is reported to be at ground level. 4.He is still trapped. 5.This is a PERIPHERAL ENTRAPMENT only. 6.The caller knows where he is: ON THE SIDE OF THE RDWY 7.The immediate area is not dangerous or hazardous. 8.He is easily accessible. -079..604917 +040.49229 PINNED BY THE BACKHOE JUST LEG IS PINNED LEG IS GOING NUMB GO UP DRIVEWAY .. ALONG THE DRIVE WAY FIRE TAC4 BEEN PINNED A COUPLE MINUTES  Disp: STAT0049,STAT0064,STAT0078,STAT0102
...
public class PAWestmorelandCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T17",
        ...
        "CITY:WASHINGTON TWP",
        "PLACE:GLASSMART",
        "X:ROUTE 380 & BEAVER RUN RD",
        "ID:F12020572",
        "CALL:SMOKE SMOKE INVESTIGATION",
        "NAME:GLASS MART FOOD ST");

    doTest("T18",
        "Loc: 5630 GREENSBURG RD WASH_T X-sts: WASHINGTON RD & SPRING HILL RD  Inc#:F13013216 NATURE: 22B02 INACC INC/PERIPHERAL ENTRAP  CALLER: DON GRICE TOC: 09:42:32 Fire TAC:  EMS Tac: Comments: MALE PINNED BETWEEN TREE AND MACHINE Response text: Bravo Responder script: 47 year old, Male, Conscious, Breathing. Inaccessible Incident / Other Entrapments (Non-Vehicle). 1.This incident does not involve the release of hazardous materials. 2.He is trapped in machinery. 3.The accident is reported to be at ground level. 4.He is still trapped. 5.This is a PERIPHERAL ENTRAPMENT only. 6.The caller knows where he is: ON THE SIDE OF THE RDWY 7.The immediate area is not dangerous or hazardous. 8.He is easily accessible. -079..604917 +040.49229 PINNED BY THE BACKHOE JUST LEG IS PINNED LEG IS GOING NUMB GO UP DRIVEWAY .. ALONG THE DRIVE WAY FIRE TAC4 BEEN PINNED A COUPLE MINUTES  Disp: STAT0049,STAT0064,STAT0078,STAT0102",
        "ADDR:5630 GREENSBURG RD",
        "CITY:WASHINGTON TWP",
        "X:WASHINGTON RD & SPRING HILL RD",
        "ID:F13013216",
        "CALL:22B02 INACC INC/PERIPHERAL ENTRAP",
        "NAME:DON GRICE",
        "INFO:MALE PINNED BETWEEN TREE AND MACHINE",
        "UNIT:STAT0049,STAT0064,STAT0078,STAT0102");
