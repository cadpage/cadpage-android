...
0171008 500 DELAWARE AV ES TN  X1: BARTRAM AV X2: JANSEN AV Nature: ALARM AUTOMATIC FIRE ALARM Time: 17:52:30  Notes: KITCHEN AREA   Inc: F12022844
0177009 653 SAUDE AV ES TN  X1: SENECA ST X2: DELAWARE AV Nature: ALS-EMS NATURE UNKNOWN Time: 19:24:35  Notes:  41 YOF   Inc: F12022856
0177009 200 STEVENS DR LS TN : @KEYSTONE MERCY X1: N GOVERNOR PRINTZ BLVD Nature: ALS-EMS  UNCONCIOUS PERSON Time: 15:09:00  Notes:  2ND FLOOR PREGNANT FEM    2ND CALL EMS 02   Inc: F12023375
...
Contact: Active911
Agency name: Delaware County PA
Location: Drexel Hill, PA, United States

1040017  X1: BALTIMORE PKE X2: VALLEYBROOK RD Nature: ACC  WITH ENTRAPMENT Time: 01:32:14  Notes: PSP ON LOCATION   1 FEMALE UNCONSCIOUS   Inc: F12056580 Beat CH1 \r\n\r\n
0641008  50 TANGUY RD TB  X1: PORTSMOUTH E X2: CREEK RD Nature: ACC  WITH ENTRAPMENT Time: 10:31:06  Notes: VEH OVERTURNED    2ND EMER FOR AMB 59   Inc: F12056250 Beat EG1 \r\n\r\n
0671008  1613 CONSTITUTION AV RT  X1: BULLENS LN X2: LIBERTY RD Nature: ACC  WITH ENTRAPMENT Time: 09:08:45  Inc: F12056229 Beat WO1 \r\n\r\n
...
public class PADelawareCountyBParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T11",
        ...
        "MADDR:WEST CHESTER PIKE & PARK AVE",
    ...
    doTest("T17",
        "0171008 500 DELAWARE AV ES TN  X1: BARTRAM AV X2: JANSEN AV Nature: ALARM AUTOMATIC FIRE ALARM Time: 17:52:30  Notes: KITCHEN AREA   Inc: F12022844",
        "UNIT:0171008",
        "ADDR:500 DELAWARE AV",
        "MADDR:500 DELAWARE AVE",
        "CITY:ESSINGTON",
        "X:BARTRAM AV & JANSEN AV",
        "CALL:ALARM AUTOMATIC FIRE ALARM",
        "TIME:17:52:30",
        "INFO:KITCHEN AREA",
        "ID:F12022844");
    ...
    doTest("T19",
        ...
        "ADDR:200 STEVENS DR",
        "CITY:LESTER",
        "PLACE:KEYSTONE MERCY",
        "X:N GOVERNOR PRINTZ BLVD",
        "CALL:ALS-EMS  UNCONCIOUS PERSON",
        "TIME:15:09:00",
        "INFO:2ND FLOOR PREGNANT FEM    2ND CALL EMS 02",
        "ID:F12023375");
  ...
  public void testActive911Cap() {
    ...
    doTest("T37",
        ...
        "MADDR:WEST CHESTER PIKE & TERMINAL SQ",
        "CALL:ALS-EMS  UNCONCIOUS PERSON",
        "TIME:11:16:21",
  ...
  public void testActive911B() {
    ...
    doTest("T1",
        ...
        "UNIT:1040017",
        "ADDR:BALTIMORE PKE & VALLEYBROOK RD",
        "MADDR:BALTIMORE PIKE & VALLEYBROOK RD",
        "CALL:ACC  WITH ENTRAPMENT",
        "TIME:01:32:14",
        "INFO:PSP ON LOCATION   1 FEMALE UNCONSCIOUS",
        "ID:F12056580",
        "BOX:CH1");
    ...
    doTest("T2",
        ...
        "ADDR:50 TANGUY RD",
        "CITY:THORNBURY TWP",
        "X:PORTSMOUTH E & CREEK RD",
        "CALL:ACC  WITH ENTRAPMENT",
        "TIME:10:31:06",
        "INFO:VEH OVERTURNED    2ND EMER FOR AMB 59",
        "ID:F12056250",
        "BOX:EG1");
    ...
    doTest("T3",
        ...
        "UNIT:0671008",
        "ADDR:1613 CONSTITUTION AV",
        "MADDR:1613 CONSTITUTION AVE",
        "CITY:RIDLEY TWP",
        "X:BULLENS LN & LIBERTY RD",
        "CALL:ACC  WITH ENTRAPMENT",
        "TIME:09:08:45",
        "ID:F12056229",
        "BOX:WO1");
