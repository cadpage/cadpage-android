...
Contact: Daniel Fisher <daniel27166565@gmail.com>
CodeMessaging client
Box:27-3 XSts:E MIDDLE RD ,HILL LN Event Type:TRAFFIC / TRANSPORTATION ACCIDENT INJURIES Class:  Disp: R27

Contact: Russell <rwalbornjr@comcast.net>
Sender: GCM (CodeMessaging)
Box:26-3 Loc:225 TROUP RD MFT DAUP XSts:SAVIDGE RD ,MATTERSTOWN RD Event Type:STRUCTURE FIRE COMMERCIAL Class: 1 Disp: E26,B26,E21,E28,L20,S26,R21,T26,T21,T28
Box:27-1 Loc:859 E MARKET ST LYT DAUP XSts:SCHOOL HOUSE DR ,THEATER LN Event Type:STRUCTURE FIRE RESIDENTIAL Class: 1 Disp: CH27,U22,E27,E26,L22,R27,R28,R23,EN65,E28,L20,S26,T27,T26,ES14-10,R21,E23,E21,T28

Contact: Active911
Agency name: Lower Swatara Fire Department Location: Middletown, PA 
Sender: pwd@messaging.nl

Box:59-6 XSts:OBERLIN RD ,NISSLEY DR Event Type:TRAFFIC / TRANSPORTATION ACCIDENT NO INJURIES Class:  Disp: R59,TRF59p{^"?/?GWHc+dq?r 
Box:88-3 Loc:149 WILSON ST MDT DAUP: @WOODLAYNE COURT XSts:SWAR AV ,S WOOD ST Event Type:ALARM FIRE ALARM (RESIDENTIAL MULTI-FAMILY) Class: 1 Disp: E88,E59,L88,R88` 
Box:55-1 Loc:201 PENN ST HSP DAUP: @HIGHSPIRE SCHOOL APARTMENTS: APT 116 XSts:ROOP ST ,PAXTON ST Event Type:ALARM FIRE ALARM (RESIDENTIAL MULTI-FAMILY) Class: 1 Disp: E55,E59,L50,R50,R4?p 
...
public class PADauphinCountyParserTest extends BaseParserTest {
  ...
  @Test
  public void testDanielFisher() {

    doTest("T1",
        "Box:27-3 XSts:E MIDDLE RD ,HILL LN Event Type:TRAFFIC / TRANSPORTATION ACCIDENT INJURIES Class:  Disp: R27",
        "BOX:27-3",
        "ADDR:E MIDDLE RD & HILL LN",
        "CALL:TRAFFIC / TRANSPORTATION ACCIDENT INJURIES",
        "UNIT:R27");
  ...
  public void testRussell() {
    ...
    doTest("T1",
        ...
        "ADDR:225 TROUP RD",
        "CITY:MIFFLIN TWP",
        "X:SAVIDGE RD / MATTERSTOWN RD",
        "CALL:STRUCTURE FIRE COMMERCIAL",
        "PRI:1",
        "UNIT:E26,B26,E21,E28,L20,S26,R21,T26,T21,T28");

    doTest("T2",
        "Box:27-1 Loc:859 E MARKET ST LYT DAUP XSts:SCHOOL HOUSE DR ,THEATER LN Event Type:STRUCTURE FIRE RESIDENTIAL Class: 1 Disp: CH27,U22,E27,E26,L22,R27,R28,R23,EN65,E28,L20,S26,T27,T26,ES14-10,R21,E23,E21,T28",
        "BOX:27-1",
        "ADDR:859 E MARKET ST",
        "CITY:LYKENS TWP",
        "X:SCHOOL HOUSE DR / THEATER LN",
        "CALL:STRUCTURE FIRE RESIDENTIAL",
        "PRI:1",
        "UNIT:CH27,U22,E27,E26,L22,R27,R28,R23,EN65,E28,L20,S26,T27,T26,ES14-10,R21,E23,E21,T28");
  ...
  public void testActive911A() {
    ...
    doTest("T1",
        "Box:59-6 XSts:OBERLIN RD ,NISSLEY DR Event Type:TRAFFIC / TRANSPORTATION ACCIDENT NO INJURIES Class:  Disp: R59,TRF59p{^\"?/?GWHc+dq?r ",
        "BOX:59-6",
        "ADDR:OBERLIN RD & NISSLEY DR", // Google can't find NISSLEY DR
        "CALL:TRAFFIC / TRANSPORTATION ACCIDENT NO INJURIES",
        "UNIT:R59,TRF59");
    ...
    doTest("T2",
        ...
        "ADDR:149 WILSON ST",
        "CITY:MIDDLETOWN",
        "PLACE:WOODLAYNE COURT",
        "X:SWAR AV / S WOOD ST",
        "CALL:ALARM FIRE ALARM (RESIDENTIAL MULTI-FAMILY)",
        "PRI:1",
        "UNIT:E88,E59,L88,R88");
    ...
    doTest("T3",
        ...
        "ADDR:201 PENN ST",
        "CITY:HIGHSPIRE",
        "PLACE:HIGHSPIRE SCHOOL APARTMENTS: APT 116",
        "X:ROOP ST / PAXTON ST",
        "CALL:ALARM FIRE ALARM (RESIDENTIAL MULTI-FAMILY)",
        "PRI:1",
        "UNIT:E55,E59,L50,R50,R4");
 }
