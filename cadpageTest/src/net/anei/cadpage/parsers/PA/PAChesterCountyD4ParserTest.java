...
Contact: Dick Guth <dguth01@gmail.com>
Sender: lcfc73@fdcms.info
Dispatch ** 18:00 ** ALARM - FIRE * ** 2316 CONESTOGA RD ,25 ** RITCHIE RES/610-827-9328- ** ADT/GQQ ** 877-238-7730 ** Inc

Contact: Jim Malone <jjmalone3@gmail.com>
Sender: wgr22@fdcms.info
Dispatch * 11:46 * ALARM - FIRE * * 107 WEST VIEW DR ,71 * WOODED WY & LEWISVILLE RD * TICKLE RES 610-255-4016- * NEWLON * 1201 * 12 *
Dispatch / Dispatch * 18:57 * ACCIDENT - INJURIES * * 1733 NEW LONDON RD ,72 * GOOD HOPE RD & APPLETON R * - * FRNKLN * 1207 * 12 *
Dispatch * 06:29 * ALARM - CARBON MONOXIDE * * 159 E EVERGREEN ST ,05 * EXCHANGE PL & OAKLAND AV * APT 1 LOWER LEVEL- * WGROVE * 2201 * 22 *
Dispatch * 10:30 * ALARM - FIRE * * 10 BLACKBERRY LA ,59 * DEAD END & STATE RD * ALLEN RES: 610-345-1793-10 BLA * LGROVE * 2203 * 22 *
Dispatch / Dispatch * 14:56 * ACCIDENT - UNKNOWN INJURIES * * LEWIS RD/RT 796 ,58    (V) *  * - *  * 2204 * 22 *
Dispatch / Dispatch * 03:50 * ACCIDENT - UNKNOWN INJURIES * * 700 LINCOLN ST ,06 * WHEELER BL & BALTIMORE PK * IFO- * OXFORD * 2100 * 21 *
Dispatch / Dispatch * 18:55 * FARM EQUIPMENT FIRE * * 106 REYNARD DR ,73 * STRICKERSVILLE RD & FENNE * - * LDNBRT * 3201 * 32 *
...
public class PAChesterCountyD4ParserTest extends BaseParserTest {
  ...
  public void testOthers() {
    ...
    doTest("T2",
        ...
        "TIME:11:46",
        "CALL:ALARM - FIRE",
        "ADDR:107 WEST VIEW DR",
        "CITY:NEW LONDON TWP",
        "X:WOODED WY & LEWISVILLE RD",
        "PLACE:TICKLE RES",
        "PHONE:610-255-4016",
        "BOX:1201",
        "INFO:12");
    ...
    doTest("T3",
        ...
        "ADDR:1733 NEW LONDON RD",
        "CITY:FRANKLIN TWP",
        "X:GOOD HOPE RD & APPLETON R",
        "BOX:1207",
        "INFO:12");
    ...
    doTest("T4",
        ...
        "ADDR:159 E EVERGREEN ST",
        "CITY:WEST GROVE",
        "X:EXCHANGE PL & OAKLAND AV",
        "PLACE:APT 1 LOWER LEVEL",
        "BOX:2201",
        "INFO:22");
    ...
    doTest("T5",
        ...
        "TIME:10:30",
        "CALL:ALARM - FIRE",
        "ADDR:10 BLACKBERRY LA",
        "MADDR:10 BLACKBERRY LN",
        "CITY:LONDON GROVE TWP",
        "X:DEAD END & STATE RD",
        "PLACE:ALLEN RES: 610-345-1793-10 BLA",
        "BOX:2203",
        "INFO:22");
    ...
    doTest("T8",
        "Dispatch / Dispatch * 18:55 * FARM EQUIPMENT FIRE * * 106 REYNARD DR ,73 * STRICKERSVILLE RD & FENNE * - * LDNBRT * 3201 * 32 *",
        "TIME:18:55",
        "CALL:FARM EQUIPMENT FIRE",
        "ADDR:106 REYNARD DR",
        "CITY:LANDENBERG",
        "X:STRICKERSVILLE RD & FENNE",
        "BOX:3201",
        "INFO:32");
  ...
  public static void main(String[] args) {
    new PAChesterCountyD4ParserTest().generateTests("T3");
  }
}
