...
Contact: James Leon <jimleonfame53@yahoo.com>
Sender: messaging@iamresponding.com
Subject:Station 53\n\nInitial Type: GASLKOU    Final Type: GASLKOU (GAS LEAK OUTSIDE *)\nLoc: 400 MAPLE AL ,01  btwn MAGNOLIA ST &
...
public class PAChesterCountyAParserTest extends BaseParserTest {
  ...
  @Test
  public void testJamesLeon() {

    doTest("T1",
        "Subject:Station 53\n\nInitial Type: GASLKOU    Final Type: GASLKOU (GAS LEAK OUTSIDE *)\nLoc: 400 MAPLE AL ,01  btwn MAGNOLIA ST &",
        "SRC:Station 53",
        "CALL:GASLKOU (GAS LEAK OUTSIDE *)",
        "ADDR:400 MAPLE AL",
        "MADDR:400 MAPLE ALLEY",
        "CITY:WEST CHESTER",
        "X:MAGNOLIA ST &");
