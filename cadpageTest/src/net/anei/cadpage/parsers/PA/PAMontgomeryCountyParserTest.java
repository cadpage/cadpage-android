...
public class PAMontgomeryCountyParserTest extends BaseParserTest {
  
  public PAMontgomeryCountyParserTest() {
    setParser(new PAMontgomeryCountyParser(), "MONTGOMERY COUNTY", "PA");
  }
  ...
  public static void main(String[] args) {
    new PAMontgomeryCountyParserTest().generateTests("T1");
  }
}