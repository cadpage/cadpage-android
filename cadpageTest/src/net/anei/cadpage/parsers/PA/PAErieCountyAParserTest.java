...
Contact: Steve Roney <crzystev@gmail.com>
Contact: 8144401663@vtext.com
Sender: 8149232720,:777
ERIE911:19C7 >HEART PROB/AICD - UNK STATUS 467 SHADYBROOK CIR XS: KENDORA CT GIRARD TWP Map:1206 Grids:, Cad: 2013-0000005565
ERIE911:UNCONSCIOUS CHANGING COLOR 840 TILDEN AVE XS: SUNSET DR Cad: 2013-0000005443
ERIE911:31D4 >UNCONSCIOUS CHANGING COLOR 840 TILDEN AVE XS: SUNSET DR GIRARD BORO Map:3196 Grids:, Cad: 2013-0000005443
ERIE911:21B2 >HEMORR/LACER - SERIOUS HEMORRH 231 WELLINGTON LN XS: HONEYBROOK CIR GIRARD TWP Map:1284 Grids:, Cad: 2013-0000020978
ERIE911:17A1G >FALLS-ON GRD/FL-NOT DANGER BOD 8300 W RIDGE RD Apt: J28A Bldg XS: DOBLER RD FAIRVIEW TWP Map:2185 Grids:, Cad: 2013-0000020869
.... (Girard Fire) ERIE911:17A1G >FALLS-ON GRD/FL-NOT DANGER BOD 8300 W RIDGE RD Apt: J28A Bldg XS: DOBLER RD FAIRVIEW TWP Map:2185 Grids:, Cad: 2013-0000020869

Contact: Robert Glenn <glennrobert38@gmail.com>
Sender: 8144409141
ERIE911:29D4 >MVA - PINNED / ENTRAPPED 11260 LAY RD XS: OLD STATE RD WASHINGTON TWP Map:3939 Grids:, Cad: 2013-0000023410
...
public class PAErieCountyAParserTest extends BaseParserTest {
  ...
  public void testMatExley() {
    ...
    doTest("T7",
        ...
        "SRC:West Ridge Fire",
        "CODE:29D4",
        "CALL:MVA - PINNED / ENTRAPPED",
        "ADDR:GRUBB RD & HERSHEY RD",
        "CITY:MILLCREEK TWP",
        "X:HERSHEY RD");
  ...
  @Test
  public void testSteveRoney() {

    doTest("T1",
        "ERIE911:19C7 >HEART PROB/AICD - UNK STATUS 467 SHADYBROOK CIR XS: KENDORA CT GIRARD TWP Map:1206 Grids:, Cad: 2013-0000005565",
        "SRC:ERIE911",
        "CODE:19C7",
        "CALL:HEART PROB/AICD - UNK STATUS",
        "ADDR:467 SHADYBROOK CIR",
        "CITY:GIRARD TWP",
        "X:KENDORA CT",
        "MAP:1206",
        "ID:2013-0000005565");
    ...
    doTest("T2",
        "ERIE911:UNCONSCIOUS CHANGING COLOR 840 TILDEN AVE XS: SUNSET DR Cad: 2013-0000005443",
        "SRC:ERIE911",
        "CALL:UNCONSCIOUS CHANGING COLOR",
        "ADDR:840 TILDEN AVE",
        "X:SUNSET DR",
        "ID:2013-0000005443");
    ...
    doTest("T4",
        ...
        "SRC:ERIE911",
        "CODE:21B2",
        "CALL:HEMORR/LACER - SERIOUS HEMORRH",
        "ADDR:231 WELLINGTON LN",
        "X:HONEYBROOK CIR",
        "CITY:GIRARD TWP",
        "MAP:1284",
        "ID:2013-0000020978");
    ...
    doTest("T5",
        ...
        "SRC:ERIE911",
        "CODE:17A1G",
        "CALL:FALLS-ON GRD/FL-NOT DANGER BOD",
        "ADDR:8300 W RIDGE RD",
        "APT:J28A Bldg",
        "X:DOBLER RD",
        "CITY:FAIRVIEW TWP",
  ...
  public static void main(String[] args) {
    new PAErieCountyAParserTest().generateTests("T1");
  }
}