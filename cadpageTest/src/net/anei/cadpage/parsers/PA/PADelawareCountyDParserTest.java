...
public class PADelawareCountyDParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T3",
        ...
        "CALL:ACCIDENTAL TRIP OF FIRE ALARM",
        "X:BRENNAN DR & SPROUL RD",
        "DATE:10/17/2011",
        "UNIT:ENG38",
        "ID:F11060680",
    ...
    doTest("T4",
        ...
        "ADDR:300 E EAGLE RD",
        "CALL:AUTOMATIC FIRE ALARM",
        "X:SAINT DENIS LN & SAINT DENIS LN",
        "DATE:10/13/2011",
        "UNIT:ENG38",
        "ID:F11059917",
    ...
    doTest("T8",
        ...
        "CALL:AUTOMATIC FIRE ALARM",
        "X:SAINT MARYS RD & COUNTY LINE RD",
        "DATE:10/14/2011",
        "UNIT:ENG38",
        "ID:F11060114",
