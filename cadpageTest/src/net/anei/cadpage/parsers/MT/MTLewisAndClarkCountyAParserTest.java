...
public class MTLewisAndClarkCountyAParserTest extends BaseParserTest {
  
  public MTLewisAndClarkCountyAParserTest() {
    setParser(new MTLewisAndClarkCountyAParser(), "LEWIS AND CLARK COUNTY", "MT");
  }
  ...
  public void testParser() {
    ...
    doTest("T3",
        ...
        "MADDR:GREEN MEADOW DR & W CUSTER AVE",
        "NAME:JOHN DOE",
        "PHONE:465-1234",
  ...
  public static void main(String[] args) {
    new MTLewisAndClarkCountyAParserTest().generateTests();
  }
}
