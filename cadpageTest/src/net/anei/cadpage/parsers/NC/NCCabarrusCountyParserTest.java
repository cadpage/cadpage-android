...
public class NCCabarrusCountyParserTest extends BaseParserTest {
  
  public NCCabarrusCountyParserTest() {
    setParser(new NCCabarrusCountyParser(), "CABARRUS COUNTY", "NC");
  }
