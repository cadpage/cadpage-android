...
public class NCAlexanderCountyParserTest extends BaseParserTest {
  ...
  public static void main(String[] args) {
    new NCAlexanderCountyParserTest().generateTests("T1");
  }
}
