...
public class NCSurryCountyParserOldTest extends BaseParserTest {
  
  public NCSurryCountyParserOldTest() {
    setParser(new NCSurryCountyParserOld(), "SURRY COUNTY", "NC");
  }
  ...
  public static void main(String[] args) {
    new NCSurryCountyParserOldTest().generateTests("T1", "ID ADDR CITY CALL");
  }
}
