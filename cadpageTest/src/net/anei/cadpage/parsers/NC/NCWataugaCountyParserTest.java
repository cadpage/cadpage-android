...
Contact: "Jimmy Isaacs" <Jimmy.Isaacs@townofboone.net>
Sender: wcc911@wataugacounty.org
BAMBOO RD / DEERFIELD APTS MDL 10D01 2012023649 19:08:31 UNKNOWN PROBLEM (MAN DOWN) 321S-DEERFIELD RD-RT AIRPORT END OF BAMBOO RD

Contact: Dan Plane <taclife03@gmail.com>
Sender: wcc911@wataugacounty.org
7395 US HWY 221 S BLOWING ROCK;2013004925;04:06:00;S5; @ TOWN LIMITS OF BLOWING ROCK OFF YONAHLOSSEE RD
1640 OLD 421 S BOONE;2013004926;05:23:03;S5; 421S-@ BREMCO LT OLD 421 S
214 GREER LN VILAS;2013004909;19:07:06;10-60; 421N-PAST NC HWY 105 BYP-2ND LT GREER LN
...
public class NCWataugaCountyParserTest extends BaseParserTest {
  ...
  @Test
  public void testJimmyIssacs() {

    doTest("T1",
        "BAMBOO RD / DEERFIELD APTS MDL 10D01 2012023649 19:08:31 UNKNOWN PROBLEM (MAN DOWN) 321S-DEERFIELD RD-RT AIRPORT END OF BAMBOO RD",
        "ADDR:BAMBOO RD",
        "PLACE:/ DEERFIELD APTS",
        "CODE:10D01",
        "ID:2012023649",
        "TIME:19:08:31",
        "CALL:UNKNOWN PROBLEM (MAN DOWN)",
        "INFO:321S-DEERFIELD RD-RT AIRPORT END OF BAMBOO RD");

  }
  
  @Test
  public void testDanPlane() {

    doTest("T1",
        "7395 US HWY 221 S BLOWING ROCK;2013004925;04:06:00;S5; @ TOWN LIMITS OF BLOWING ROCK OFF YONAHLOSSEE RD",
        "ADDR:7395 US HWY 221 S",
        "MADDR:7395 US 221 S",
        "CITY:BLOWING ROCK",
        "ID:2013004925",
        "TIME:04:06:00",
        "CALL:S5",
        "INFO:@ TOWN LIMITS OF BLOWING ROCK OFF YONAHLOSSEE RD");
    ...
    doTest("T3",
        ...
        "TIME:19:07:06",
        "CALL:10-60",
        "INFO:421N-PAST NC HWY 105 BYP-2ND LT GREER LN");
   
  }

  public static void main(String[] args) {
    new NCWataugaCountyParserTest().generateTests("T1");
  }
}
