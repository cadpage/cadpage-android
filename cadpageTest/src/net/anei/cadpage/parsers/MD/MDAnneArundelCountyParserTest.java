...
public class MDAnneArundelCountyParserTest extends BaseParserTest {
  
  public MDAnneArundelCountyParserTest() {
    setParser(new MDAnneArundelCountyParser(), "ANNE ARUNDEL COUNTY", "MD");
  }
  ...
  public static void main(String[] args) {
    new MDAnneArundelCountyParserTest().generateTests("T1");
  }
}