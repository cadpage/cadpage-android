...
Contact: Bruce Bridgett <pgfd13192@gmail.com>
Sender: alrt_HQ4O@alert.co.pg.md.us
(1/2) F123560177: House Fire, 11800 LILIUM LN, PP, btwn END and COSMOS CT, TGA3, 1814, Units:BO881, BO882, E816, E818, E819B,
...
Prince Georges County, MD
Contact: Active911
Agency name: West Lanham Hills Co 28
Location: Hyattsville, MD, United States

(CAD Feed) F122770359: BLS Amb, 5426 85TH AVE #202, PP, btwn ELLIN RD and ANNAPOLIS RD, TGA2, 2805, Units:A830, E828
(CAD Feed) F122770233: Medic Local, 9013 ANNAPOLIS RD, PP, btwn NB CAP BELT HWY OFRP EB ANNAPOLIS RD and LANHAM SEVEN R, TGA2, 2806, Units:E828, PA806
(CAD Feed) F122770177: Medic Local, METRO NEW CARROLLTON - S, PP, at 4201 ELLIN RD, PP, TGA2, 2803, Units:A813, MD830, TK828
(CAD Feed) F122770171: Fire Alarm-AFA, 7963 ANNAPOLIS RD, PP, btwn CROSS ST and RIVERDALE RD, TGA2, 2804, Units:PE830, TK828
(CAD Feed) F122770130: Medic Local, 5811 LAWTON CT, PP, btwn ELLARD DR and END, TGA2, 4832, Units:A806, E828, NMR
(CAD Feed) F122770060: BLS Amb, 6708 TERRA ALTA DR, PP, btwn GOOD LUCK RD and TERRA ALTA CT, TGA2, 4812, Units:A813, E828
(CAD Feed) F122770029: Medic Local, 5907 HARLAND ST, PP, btwn OAKCREST DR and GAIRLOCK PL, TGA2, 4801, Units:A807, E828, MD830
(CAD Feed) F122770001: Apartment Gas Leak, 6702 LAKE PARK DR #303, GP, btwn HANOVER PKY and VILLAGE PARK DR, TA11, 4829, Units:BO882, E828, E835B, TK812, TK814
(CAD Feed) F122760369: Hazmat Local, 3500 PENNSY DR, PP, btwn VETERANS PKY and NB PENNSY DR ONRP VETERANS PKY, TGD3, 2839, Units:A807, BO882, C6799, E828, HSC812, MD818, SEMSDO, TW833
(CAD Feed) F122760362: Medic Local, 9508 NORDIC DR, PP, btwn 96TH AVE and 96TH PL, TGA2, 4821, Units:A818, E828, MD818

Contact:  Robert Tripe <rmtripe@gmail.com>
Sender: 12101
F132130393: Apartment Fire, 6156 SPRINGHILL TER #102, GP, btwn SPRINGHILL DR and END, TGA3, 1409, Units:A813, BO884, BO886, E807, E811B, E812, E835, TK809, TK814, TK831=

Contact: Dorothy Burket <dottieburket@gmail.com>
Sender: alrt_OA62@alert.co.pg.md.us
F132230042: Acc w/Inj, DOWER HOUSE RD/EB PENNSYLVANIA AVE, PP,  <5050/ 9099>, TGA2, 2305, Units:A823, E823B, RE827\n
...
public class MDPrinceGeorgesCountyEParserTest extends BaseParserTest {
  ...
  public void testChristopherOlsen() {
    ...
    doTest("T7",
        ...
        "MADDR:CAPITAL BELTWAY & BALTIMORE WASHINGTON PKWY",
        "CH:TGB3",
        "BOX:3516",
        "MAP:5410 J 2",
    ...
    doTest("T20",
        ...
        "ID:F123560177",
        "CALL:House Fire",
        "ADDR:11800 LILIUM LN",
        "X:END and COSMOS CT",
        "CH:TGA3",
        "BOX:1814",
        "UNIT:BO881,BO882,E816,E818,E819B");
  ...
  public void testActive911B() {
    ...
    doTest("T2",
        ...
        "ID:F122770233",
        "CALL:Medic Local",
        "ADDR:9013 ANNAPOLIS RD",
        "X:NB CAP BELT HWY OFRP EB ANNAPOLIS RD and LANHAM SEVEN R",
        "CH:TGA2",
        "BOX:2806",
        "UNIT:E828,PA806");
    ...
    doTest("T3",
        ...
        "ID:F122770177",
        "CALL:Medic Local",
        "PLACE:METRO NEW CARROLLTON - S",
        "ADDR:4201 ELLIN RD",
        "CH:TGA2",
        "BOX:2803",
        "UNIT:A813,MD830,TK828");

    doTest("T4",
        "(CAD Feed) F122770171: Fire Alarm-AFA, 7963 ANNAPOLIS RD, PP, btwn CROSS ST and RIVERDALE RD, TGA2, 2804, Units:PE830, TK828",
        "ID:F122770171",
        "CALL:Fire Alarm-AFA",
        "ADDR:7963 ANNAPOLIS RD",
        "X:CROSS ST and RIVERDALE RD",
        "CH:TGA2",
        "BOX:2804",
        "UNIT:PE830,TK828");
    ...
    doTest("T6",
        ...
        "ID:F122770060",
        "CALL:BLS Amb",
        "ADDR:6708 TERRA ALTA DR",
        "X:GOOD LUCK RD and TERRA ALTA CT",
        "CH:TGA2",
        "BOX:4812",
        "UNIT:A813,E828");
    ...
    doTest("T7",
        ...
        "ID:F122770029",
        "CALL:Medic Local",
        "ADDR:5907 HARLAND ST",
        "X:OAKCREST DR and GAIRLOCK PL",
        "CH:TGA2",
        "BOX:4801",
        "UNIT:A807,E828,MD830");

    doTest("T8",
        "(CAD Feed) F122770001: Apartment Gas Leak, 6702 LAKE PARK DR #303, GP, btwn HANOVER PKY and VILLAGE PARK DR, TA11, 4829, Units:BO882, E828, E835B, TK812, TK814",
        "ID:F122770001",
        "CALL:Apartment Gas Leak",
        "ADDR:6702 LAKE PARK DR",
        "APT:303",
        "X:HANOVER PKY and VILLAGE PARK DR",
        "CH:TA11",
        "BOX:4829",
        "UNIT:BO882,E828,E835B,TK812,TK814");
    ...
    doTest("T9",
        ...
        "CALL:Hazmat Local",
        "ADDR:3500 PENNSY DR",
        "X:VETERANS PKY and NB PENNSY DR ONRP VETERANS PKY",
        "CH:TGD3",
        "BOX:2839",
        "UNIT:A807,BO882,C6799,E828,HSC812,MD818,SEMSDO,TW833");
    ...
    doTest("T10",
        ...
        "CALL:Medic Local",
        "ADDR:9508 NORDIC DR",
        "X:96TH AVE and 96TH PL",
        "CH:TGA2",
        "BOX:4821",
        "UNIT:A818,E828,MD818");
 
  }
  
  @Test
  public void testRobertTripe() {

    doTest("T1",
        "F132130393: Apartment Fire, 6156 SPRINGHILL TER #102, GP, btwn SPRINGHILL DR and END, TGA3, 1409, Units:A813, BO884, BO886, E807, E811B, E812, E835, TK809, TK814, TK831=",
        "ID:F132130393",
        "CALL:Apartment Fire",
        "ADDR:6156 SPRINGHILL TER",
        "APT:102",
        "X:SPRINGHILL DR and END",
        "CH:TGA3",
        "BOX:1409",
        "UNIT:A813,BO884,BO886,E807,E811B,E812,E835,TK809,TK814,TK831=");

  }
  
  @Test
  public void testDorthyDurket() {

    doTest("T1",
        "F132230042: Acc w/Inj, DOWER HOUSE RD/EB PENNSYLVANIA AVE, PP,  <5050/ 9099>, TGA2, 2305, Units:A823, E823B, RE827\n",
        "ID:F132230042",
        "CALL:Acc w/Inj",
        "ADDR:DOWER HOUSE RD & EB PENNSYLVANIA AVE",
        "MADDR:DOWER HOUSE RD & PENNSYLVANIA AVE",
        "CH:TGA2",
        "BOX:2305",
        "UNIT:A823,E823B,RE827");
