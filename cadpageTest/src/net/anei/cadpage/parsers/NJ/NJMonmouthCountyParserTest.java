...
public class NJMonmouthCountyParserTest extends BaseParserTest {
  ...
  public static void main(String[] args) {
    new NJMonmouthCountyParserTest().generateTests("T5");
  }
}