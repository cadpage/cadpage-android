...
public class NJSalemCountyAParserTest extends BaseParserTest {
  
  public NJSalemCountyAParserTest() {
    setParser(new NJSalemCountyAParser(), "SALEM COUNTY", "NJ");
  }
  ...
  public static void main(String[] args) {
    new NJSalemCountyAParserTest().generateTests("T1", "CALL ADDR APT X CITY NAME PHONE");
  }
}