...
public class NJWayneTownshipParserTest extends BaseParserTest {
  ...
  public void testParser1() {
    ...
    doTest("T1",
        ...
        "UNIT:C1 C2",
        "INFO:ZONE 3 FIRE ALARM/IDHIT/8772387739/ACWN/ADT");
    ...
    doTest("T2",
        ...
        "MADDR:1520 Rt 23",
        "UNIT:C3 C1 C2 C5",
        "INFO:Loc changed\nfrom {1530 Rt23;PD} to {1520 Rt23;PD}\nPri from -> 5 to 1\nElco admin services\nRough,Jim  862 226 9566\nCaller stated her heard a popping sound inside the building and they nsmell smoke\nAddress in 1538 rt23  behing wayne Hardware");
    ...
    doTest("T3",
        ...
        "MADDR:520 Rt 46",
        "UNIT:C1 C2",
        "INFO:Adt/877 2387739/id iub/acwn\nRed Lobster\nzone 18 ANSUL");
    ...
    doTest("T4",
        ...
        "UNIT:R5 C1",
        "INFO:Caller states the white suv flipped over  -\nmight be trapped inside - caller not involed - Caller states white suv\nposs trapped States 4 veh involved - caller not involed -");
