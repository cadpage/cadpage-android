...
public class DEKentCountyParserTest extends BaseParserTest {
  
  public DEKentCountyParserTest() {
    setParser(new DEKentCountyParser(), "KENT COUNTY", "DE");
  }
  ...
  public static void main(String[] args) {
    new DEKentCountyParserTest().generateTests("T1");
  }
}
