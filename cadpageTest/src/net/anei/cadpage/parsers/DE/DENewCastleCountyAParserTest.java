...
Contact: Matthew Wolter <mwolter@udel.edu>
[eFB] F00 14:05 1 - T:52C3G (L1*COMMERCIAL FIRE ALARM) L:153 COURTNEY ST ,3A -- INTERNTL HOUSE *UD EAST CAMPUS - X:btwn ACADEMY ST ~ MANUEL ST DESC: alarm.�!�!�!
...
public class DENewCastleCountyAParserTest extends BaseParserTest {
  ...
  @Test
  public void testMathewWolter() {

    doTest("T1",
        "[eFB] F00 14:05 1 - T:52C3G (L1*COMMERCIAL FIRE ALARM) L:153 COURTNEY ST ,3A -- INTERNTL HOUSE *UD EAST CAMPUS - X:btwn ACADEMY ST ~ MANUEL ST DESC: alarm.�!�!�!",
        "CALL:52C3G (L1*COMMERCIAL FIRE ALARM)",
        "ADDR:153 COURTNEY ST",
        "PLACE:INTERNTL HOUSE *UD EAST CAMPUS",
        "X:ACADEMY ST & MANUEL ST",
        "INFO:alarm.�!�!�!");
