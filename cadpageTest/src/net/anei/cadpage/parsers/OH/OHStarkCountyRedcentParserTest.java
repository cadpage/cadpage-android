...
(Brewster) RED:[RC77]- NATURE: EMERGENCY MEDICAL CALL LOCATION: 264 MOHICAN ST NE BREWSTER BETWEEN DEAD END / HURON COMMENTS: DIFF BRE ATHING 4072 BACK
...
public class OHStarkCountyRedcentParserTest extends BaseParserTest {
  ...
  @Test
  public void testDavidHess() {

    doTest("T1",
        "(Brewster) RED:[RC77]- NATURE: EMERGENCY MEDICAL CALL LOCATION: 264 MOHICAN ST NE BREWSTER BETWEEN DEAD END / HURON COMMENTS: DIFF BRE ATHING 4072 BACK",
        "UNIT:RC77",
        "CALL:EMERGENCY MEDICAL CALL",
        "ADDR:264 MOHICAN ST NE",
        "CITY:BREWSTER",
        "X:DEAD END / HURON",
        "INFO:DIFF BRE ATHING 4072 BACK");
