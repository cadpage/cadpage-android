...
public class OHHamiltonCountyParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T3",
        ...
        "CITY:SPRINGDALE",
        "NAME:PLANT MAINT ENG WIRELESS-VERIZON WIR",
        "CALL:STRUCTURE FIRE",
    ...
    doTest("T4",
        ...
        "CITY:FOREST PARK",
        "NAME:INTERSECTION T-MOBILE USA, INC",
    ...
    doTest("T10",
        ...
        "ADDR:70 DAMON RD",
        "CITY:GREENHILLS",
        "NAME:ALOIS ALZHEIMER CTR STEPHANIE",
        "CALL:STRUCTURE FIRE",
  ...
  public void testParser2() {
    ...
    doTest("T1",
        ...
        "NAME:INDN GENTILE RESD INDN PD",
        "CALL:FIRE ALARM",
        "INFO:GENERAL",
    ...
    doTest("T5",
        ...
        "ADDR:7850 TECUMSEH TL INDN INDN PD",
        "CALL:FIRE ALARM",
  ...
  public static void main(String[] args) {
    new OHHamiltonCountyParserTest().generateTests("T1", "ADDR CITY APT NAME CALL INFO UNIT X");
  }
}