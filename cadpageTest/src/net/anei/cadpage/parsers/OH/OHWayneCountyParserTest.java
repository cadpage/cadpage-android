...
public class OHWayneCountyParserTest extends BaseParserTest {
  ...
  public OHWayneCountyParserTest() {
    setParser(new OHWayneCountyParser(), "WAYNE", "OH");
  }
  ...
  public void testParser() {
    ...
    doTest("T2",
        ...
        "CALL:ACCIDENT",
        "ADDR:EASTERN RD",
        "INFO:AKRON RD 911 CELL CALL FALINE JONES REF ACCIDENT UNK INJURIES NORTON FIRE / POLICE RESPONDING");

    doTest("T3",
        "taccad:ASSAULT 351 COLLIER DR 911 CELL JESSICA KLATIK REQUEST OFFICER FOR AN ASSAULT",
        "CALL:ASSAULT",
        "ADDR:351 COLLIER DR",
        "INFO:CELL JESSICA KLATIK REQUEST OFFICER FOR AN ASSAULT");
    ...
    doTest("T5",
        ...
        "CALL:SQUAD RUN",
        "ADDR:142 HOMAN DR",
        "INFO:YOF DIFF BREATHING MARCELLA PRIDE");
    ...
    doTest("T7",
        ...
        "INFO:CALL JUDITH DAKOSKI REQUEST SQUAD 75 YOM HEART CONDITION NOW VOMITING AND DIARRHEA");

    doTest("T8",
        "taccad:SQUAD RUN 490 E CLINTON 911 CALL - 57 YOF DIFF BREATHING",
        "ADDR:SQUAD RUN",
        "INFO:E CLINTON 911 CALL - 57 YOF DIFF BREATHING");
    ...
    doTest("T10",
        ...
        "CALL:ACCIDENT GREAT",
        "ADDR:LAKES BLVD",
        "INFO:GRILL RD MULTIPLE 911 CALLS PICK UP ON ITS TOP IN THE MEDIUM");
    ...
    doTest("T12",
        ...
        "INFO:NICOLE SHORTRIDGE REQUEST SQUAD 26 YOF WITHDRAWAL FROM MEDICATIONS");

    doTest("T13",
        "taccad:SQUAD RUN 14083 HATFIELD RD 87 YO M FALL VICTIM POSSIBLE BROKEN HIP",
        "CALL:SQUAD RUN",
        "ADDR:14083 HATFIELD RD",
        "INFO:YO M FALL VICTIM POSSIBLE BROKEN HIP");
  }
  
  public static void main(String[] args) {
    new OHWayneCountyParserTest().generateTests("T1","CALL ADDR INFO");
  }
}