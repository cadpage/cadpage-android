...
Contact: Fred Griffin <fog89600@gmail.com>
Sender: 40404
@Wayne_Co_IN_911: 03/27/2013 20:38: Vehicle crash with a deer at N  BRICK CHURCH RD // LOST MILE RD/HAGERSTOWN
...
public class INWayneCountyParserTest extends BaseParserTest {
  ...
  @Test
  public void testFredGriffin() {

    doTest("T1",
        "@Wayne_Co_IN_911: 03/27/2013 20:38: Vehicle crash with a deer at N  BRICK CHURCH RD // LOST MILE RD/HAGERSTOWN",
        "DATE:03/27/2013",
        "TIME:20:38",
        "CALL:Vehicle crash with a deer",
        "ADDR:N  BRICK CHURCH RD & LOST MILE RD",
        "CITY:HAGERSTOWN");
    
  }
  
  public static void main(String[] args) {
    new INWayneCountyParserTest().generateTests("T1");
  }
}