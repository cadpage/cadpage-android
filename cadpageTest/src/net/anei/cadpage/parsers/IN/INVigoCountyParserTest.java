...
Contact: "dmeturner@aol.com" <dmeturner@aol.com>
Sender: Cisco.Paging@VigoCounty.IN.Gov
(SICK PERSON) Loc:1901 S 18TH ST Grid:0799 Units:M-8 Rmk:47 YEARS F ;HEAD PAIN CANT SEE OUT OF LEFT EYE

Contact: kyle osborne <osborne1777@gmail.com>
Sender: Cisco.Paging@VigoCounty.IN.Gov
(FALL) Loc:6502 N DEE ST Grid:0080 Units:R-1 Rmk:81 YEARS F ;FALL
...
public class INVigoCountyParserTest extends BaseParserTest {
  ...
  public void testMeturner() {
    ...
    doTest("T1",
        ...
        "MAP:0799",
        "UNIT:M-8",
        "INFO:47 YEARS F ;HEAD PAIN CANT SEE OUT OF LEFT EYE");

  }
  
  @Test
  public void testKyleOsborne() {
