...
- 02:13PM 10/21/2012 Ic# 9 CRASH018 Ds# 123001 Al# 1 Utl# G-82 10/21/1254499 PINE RD WA :(24500) RESEARCH DRDIRT BIKE ACCIDENT 1411,006ME10 ,1660 ,WARR1
- 01:46PM 10/22/2012 Ic# 11 MEDIC002 Ds# 120007 Al# 1 Utl# G-63 10/22/1253871 GENERATIONS DR CL :(53540) GENERATIONS DRAPT. 209 - 83 Y/O F. VOMITED AND ASPIRATED NOW C/O SOB ANDCHEST PX. 1343,010ME45 ,CLAY1

- 18 MEDIC018 ^ 56925 PEAR RD WA :\(26700) SR 2 HWM CANT WALK 2255,
- 9 CRASH018 ^ 54499 PINE RD WA :\(24500) RESEARCH DRDIRT BIKE ACCIDENT 1411,
- 11 MEDIC002 ^ 1253871 GENERATIONS DR CL :\(53540) GENERATIONS DRAPT. 209 - 83 Y/O F. VOMITED AND ASPIRATED NOW C/O SOB ANDCHEST PX. 1343,
- 12 MUAID ^ NOTRE DAME UNIVERSITY UN 28 :\( ) NONE RDCLAY WITH AN ENGINE TO STANDBY ND FIRE STATION 1354,
- 2 MEDIC021 ^ 11944 EDISON RD PE :\(55000) CEDAR TRM FELL IN TO TUB IS BLUE 0652,
...
public class INStJosephCountyParserTest extends BaseParserTest {
  ...
  public void testBrianKazmierzak() {
    ...
    doTest("T4",
        ...
        "CITY:PENN TWP",
        "X:59200 SR 331 HW",
        "INFO:M FIRST PARTY PASSING OUT / ME10 ,PENN1",
        "TIME:15:20",
        "UNIT:006");
  ...
  public void testActive911D() {
    ...
    doTest("T4",
        ...
        "CITY:PENN TWP",
        "INFO:BASSWOOD RDFIELD FIRE FROM LINES DOWN - BETWEEN DRAGOON AND 12TH",
        "TIME:14:00");
    ...
    doTest("T5",
        ...
        "CITY:LIBERTY TWP",
        "INFO:JEFFERSON STVEST. LIVE LINE DOWN IN ROADWAY.",
        "TIME:22:24");
    ...
    doTest("T6",
        ...
        "CITY:CLAY TWP",
        "INFO:OAKMONT SOUTH DRTREE AND LINES DOWN AND THEIR LIVE",
        "TIME:06:16");
    ...
    doTest("T7",
        ...
        "ADDR:58211 ASH RD",
        "CITY:PENN TWP",
        "INFO:HARRISON RDTREE AND LINES DOWN",
        "TIME:13:27");
    ...
    doTest("T8",
        ...
        "ADDR:13279 ADAMS RD",
        "CITY:HARRIS TWP",
        "INFO:CHERRY FARM TRVEST REQUESTED BY SJCPD FOR TREE IN THE ROADWAY",
        "TIME:17:54");
    ...
    doTest("T10",
        ...
        "MADDR:50585 IN 23",
        "CITY:HARRIS TWP",
        "INFO:BIRCH RDROLLOVER NO ENTRAPMENT",
        "TIME:23:17");
  ...
  public void testCodeMessaging1() {
    ...
    doTest("T1",
        ...
        "CITY:WARREN TWP",
        "X:24500 RESEARCH DR",
        "INFO:DIRT BIKE ACCIDENT / ME10 ,1660 ,WARR1",
        "TIME:14:13:00",
        "UNIT:006");
    ...
    doTest("T2",
        ...
        "MAP:G-63",
        "DATE:10/22/2012",
        "ADDR:53871 GENERATIONS DR",
        "CITY:CLAY TWP",
        "INFO:GENERATIONS DRAPT. 209 - 83 Y/O F. VOMITED AND ASPIRATED NOW C/O SOB ANDCHEST PX. / ME45 ,CLAY1",
        "TIME:13:46:00",
        "UNIT:010");
  ...
  @Test
  public void testCodeMessaging2() {
    ...
    doTest("T2",
        ...
        "CITY:WARREN TWP",
        "X:24500 RESEARCH DR",
        "INFO:DIRT BIKE ACCIDENT",
        "TIME:14:11");

    doTest("T3",
        "- 11 MEDIC002 ^ 1253871 GENERATIONS DR CL :\\(53540) GENERATIONS DRAPT. 209 - 83 Y/O F. VOMITED AND ASPIRATED NOW C/O SOB ANDCHEST PX. 1343,",
        "CALL:1 MEDIC002",
        "ADDR:1253871 GENERATIONS DR",
        "CITY:CLAY TWP",
        "INFO:GENERATIONS DRAPT. 209 - 83 Y/O F. VOMITED AND ASPIRATED NOW C/O SOB ANDCHEST PX.",
        "TIME:13:43");

    doTest("T4",
        "- 12 MUAID ^ NOTRE DAME UNIVERSITY UN 28 :\\( ) NONE RDCLAY WITH AN ENGINE TO STANDBY ND FIRE STATION 1354,",
        "CALL:2 MUAID",
        "ADDR:NOTRE DAME UNIVERSITY UN 28",
        "MADDR:NOTRE DAME UNIVERSITY UN 28 & NONE RD",
        "X:NONE RD",
        "INFO:CLAY WITH AN ENGINE TO STANDBY ND FIRE STATION",
        "TIME:13:54");

    doTest("T5",
        "- 2 MEDIC021 ^ 11944 EDISON RD PE :\\(55000) CEDAR TRM FELL IN TO TUB IS BLUE 0652,",
        "CALL:MEDIC021",
        "ADDR:11944 EDISON RD",
        "CITY:PENN TWP",
        "X:55000 CEDAR TR",
        "INFO:M FELL IN TO TUB IS BLUE",
        "TIME:06:52");

  }
 
  public static void main(String[] args) {
    new INStJosephCountyParserTest().generateTests("T1");
  }
}