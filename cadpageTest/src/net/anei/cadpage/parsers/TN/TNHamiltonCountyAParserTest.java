...
public class TNHamiltonCountyAParserTest extends BaseParserTest {
  
  public TNHamiltonCountyAParserTest() {
    setParser(new TNHamiltonCountyAParser(), "HAMILTON COUNTY", "TN");
  }
  ...
  public static void main(String[] args) {
    new TNHamiltonCountyAParserTest().generateTests("T1");
  }
}
