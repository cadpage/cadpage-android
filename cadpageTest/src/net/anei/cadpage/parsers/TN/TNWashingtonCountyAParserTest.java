...
*/
public class TNWashingtonCountyAParserTest extends BaseParserTest {
  
  public TNWashingtonCountyAParserTest() {
    setParser(new TNWashingtonCountyAParser(), "WASHINGTON COUNTY", "TN");
  }
  ...
  @Test
  public void testNathanWard() {
    
  }
  

  public static void main(String[] args) {
    new TNWashingtonCountyAParserTest().generateTests("T1");
  }
}
