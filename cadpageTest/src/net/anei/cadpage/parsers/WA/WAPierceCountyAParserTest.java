...
public class WAPierceCountyAParserTest extends BaseParserTest {
  
  public WAPierceCountyAParserTest() {
    setParser(new WAPierceCountyAParser(), "PIERCE COUNTY", "WA");
  }
  ...
  public void testRunReport() {
    ...
    doTest("T1",
        ...
        "ID:36872",
        "CALL:RUN REPORT",
        "PLACE:CALL:03:32/DISP:03:32/ENR:03:33/ATS:03:37/TRA:03:45/ATD:0 3:53/PUZIP:98408/DO:St Joseph Hospital");
  }
  ...
  public static void main(String[] args) {
    new WAPierceCountyAParserTest().generateTests("T1");
  }
}