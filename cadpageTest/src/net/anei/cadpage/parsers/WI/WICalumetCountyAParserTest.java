...
public class WICalumetCountyAParserTest extends BaseParserTest {
  
  public WICalumetCountyAParserTest() {
    setParser(new WICalumetCountyAParser(), "CALUMET COUNTY", "WI");
  }
  ...
  public void testBrownCountyParser() {
    ...
    doTest("T1",
        ...
        "MAP:9BD",
        "NAME:ED CARROL",
        "INFO:WITHIN 10 OF BUILDING, CHANGE TO STRUCTURE");
    ...
    doTest("T6",
        ...
        "INFO:WITHIN 10 OF BUILDING, CHANGE TO STRUCTURE",
        "TIME:01:27",
        "UNIT:HBEN1711 :74 HBEN1712 21:");
    
  }
  
  public static void main(String[] args) {
    new WICalumetCountyAParserTest().generateTests("T6");
  }
}