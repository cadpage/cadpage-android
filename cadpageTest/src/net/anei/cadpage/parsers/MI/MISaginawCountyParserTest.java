...
Contact: Jason Judd <jason.judd651@gmail.com>
Sender: 34292
LOC:S 27TH / E HOLLAND DESC:ONE FEMALE UNCONSCIOUS TYP:*M*INJURY

Contact: timothy gray <graysgreengrass@gmail.com>
Sender: 34292
LOC:1651 APPLEBLOSSOM LN N DESC:77 M DIFF BREATHING TYP:*M*SICK PE
...
public class MISaginawCountyParserTest extends BaseParserTest {
  ...
  @Test
  public void testJasonJudd() {

    doTest("T1",
        "LOC:S 27TH / E HOLLAND DESC:ONE FEMALE UNCONSCIOUS TYP:*M*INJURY",
        "ADDR:S 27TH & E HOLLAND",
        "INFO:ONE FEMALE UNCONSCIOUS",
        "CALL:INJURY");

  }
  
  @Test
  public void testTimothyGray() {

    doTest("T1",
        "LOC:1651 APPLEBLOSSOM LN N DESC:77 M DIFF BREATHING TYP:*M*SICK PE",
        "ADDR:1651 APPLEBLOSSOM LN N",
        "INFO:77 M DIFF BREATHING",
        "CALL:SICK PE");
