...
public class FLPensacolaParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T4",
        ...
        "UNIT:ENG1,",
        "CALL:RESCUE",
        "PLACE:X2[LANCELOT DR]",
        "ADDR:7965  GAWIN DR ",
        "X:KING ARTHUR DR",
        "CITY:PENSACOLA",
        "ST:FL",
        "DATETIME:2012-06-25 09:18:55",
        "INFO: ",
        "SRC:ENG2");
    ...
    doTest("T6",
        ...
        "UNIT:ENG6,",
        "CALL:RESCUE",
        "PLACE:THE FLATS AT 9TH AVENUE  308-5345 X2[BEAU TERRA LN]",
        "ADDR:7601 N 9TH AV 107 ",
        "X:I10",
        "CITY:PENSACOLA",
        "ST:FL",
        "DATETIME:2012-06-24 23:18:28",
        "INFO: ",
        "SRC:ENG6");
  }
