...
public class GeneralParserTest extends BaseParserTest {
  ...
  public void testParser() {
    ...
    doTest("T33", "S/B AT HELICOPTER LANDING ~ E98 ~ 1600 BLACK ROCK RD ~ UPRO ~ S TRAPPE RD AND DREIBELBI ~ F1304092 ~ Dispatch ~ 11:49 ~ PROVIDENCE POINTE SKILLED NURS ~  ~  ~ 68-94 ~  ~ C/A\r\n40'S/F\r\nIN THE DINNING ROOM IN NORTH 2\r\nOBTAIN WHICH NURSING CENTER  and  ROOM# - SEE \"CN\" FOR ~",
        "CALL:S/B AT HELICOPTER LANDING",
        "UNIT:E98",
        "ADDR:1600 BLACK ROCK RD",
        "TIME:11:49",
        "INFO:UPRO ~ S TRAPPE RD AND DREIBELBI ~ Dispatch ~ PROVIDENCE POINTE SKILLED NURS ~ 68-94 ~ C/A\n 40'S/F\n IN THE DINNING ROOM IN NORTH 2\n OBTAIN WHICH NURSING CENTER and",
        "ID:- SEE \"CN\" FOR");
  }
}