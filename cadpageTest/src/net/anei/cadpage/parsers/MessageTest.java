...
public class MessageTest {
  ...
  public void testParseInfo() {
    ...
    doParseTest("PABerksCOunty",
        ...
        "ken@cadpage.org",
        "",
        "Unit:RE7 Status:Dispatched SF ; 621 KATHRYN ST ; ; DARIEN ST / SNYDER ST ; READING ; GREY BLK SMOKE COMING FROM CHIMNEY ; 0;", 1, 2);
    
    doParseTest("NJNassauCountyRedAlert",
        "ken@cadpage.org",
        "",
        ...
        "vtext.com@mxh3.email-od.com",
        "",
        "House Fires (Phone In) at 58 BARNYARD LN, LEVITTOWN  c/s: BROOK LN   O: CONTI . . 15:53:36");
    
    doParseTest("NJLivingstonCounty",
        "ken@cadpage.org",
        "",
        ...
        "",
        "CAD:PIA;CHILSON RD/E GRAND RIVER;[LAW] RED BID AS PIA [07/11/13 14:35:24 DDEMAN] CAR IS PINNED AGAINST THE TOR OF THE CONSTRUCTION VEHICLE [07/11/13 14:34:31 CWESTPHAL] BID [07/11/13 14:33:51 DDEMAN] BLK TRAILBLAZER VS CONSTRUCTION VEHICLE");
    
    doParseTest("NJOceanCounty",
        "ken@cadpage.org",
        ...
        "<Fire_Records>",
        "[OCSD] Rip and Run Report",
        "Rip and Run Report\n\n~\nLocation Information:\n\nLocation:~7~BALLAST~AVE~\nVenue:~Barnegat Township\nCross Streets~\nWATTS AVE / DEAD END\nQuadrant:~ST11/ST12\nDistrict:~SQ11\n~\nCall Information:\n\nCall Number:~126158\nCall Type:~ Appliance Fire\nSource:~911\nPriority:~ Medium\nStatus:~In Progress\nCaller:~\nCall Date/Time:~06/04/2013 18:10:59\nDispatch Date/Time:~06/04/2013 18:12:11\nArrive Date/Time:~06/04/2013 18:19:30\nClear Date/Time:~06/04/2013 18:34:01\nEnroute Date/Time:~06/04/2013 18:14:01\nLatest Unit Cleared Date/Time:~06/04/2013 18:34:01\n~\nIncident Number(s)\n2013-00000188~~Barnegat Fire Department\n~\nUnits Sent:~5\nF1115, ST11, F1141, F1110, F1100~\n\nAlerts:\n~\nLocation Alerts\n\nPerson Alerts\n\nVehicle Alerts\n~~\nNarrative:\n\nNarrative Time~Narrative\n06/04/13 18:11:53~Nature Of Call: GRILL FIRE\n\n\n_______________________________________________\nOCSD mailing list\nOCSD@station11.org\nhttp://station11.org/mailman/listinfo/ocsd_station11.org");
    
    doParseTest("INHamiltonCounty",
        "ken@cadpage.org",
        "",
        "(Text Message 1of4) CAD:E83,A82 INJ PRSN 4624 MCKINLEY CT WES (S)SUMMIT LAKES ADDITION (N) 83 [Medical Priority Info] RESPONSE: Priority 4 RESPONDER SCRIPT: Y",
        "ken@cadpage.org",
        "Text Message",
        "CAD:E83,A82 INJ PRSN 4624 MCKINLEY CT WES (S)SUMMIT LAKES ADDITION (N) 83 [Medical Priority Info] RESPONSE: Priority 4 RESPONDER SCRIPT: Y", 1, 4);
    
    doParseTest("BadMsgIndex",
        "ken@cadpage.org",
        "",
        "(- part 1 of 1) RC:Go to post 851\r\n",
        "ken@cadpage.org",
        "",
        "RC:Go to post 851\n", 1, 1);
    
    doParseTest("WYNatronaCounty",
        "ken@cadpage.org",
        "",
        "(Message from HipLink) 1/1 EVF \n  Fall\n  1180 WESTERN AVE; Butch's Happy Days Liq\n  351\n  R12\n  ****TAC 4****POSSIBLE BROKEN ANKLE",
        "ken@cadpage.org",
        "Message from HipLink",
        "EVF \n  Fall\n  1180 WESTERN AVE; Butch's Happy Days Liq\n  351\n  R12\n  ****TAC 4****POSSIBLE BROKEN ANKLE", 1, 1);
    
    doParseTest("General",
        "ken@cadpage.org",
        "",
        "\n3/25/2013 11:04:49 AM WFS1 : DSPTCH & primary unit. \n",
        "ken@cadpage.org",
        "",
        "3/25/2013 11:04:49 AM WFS1 : DSPTCH & primary unit. \n");
    ...
    doParseTest("COOrangeCountyB",
        "ken@cadpage.org",
        "",
        "((1/3)OC911 ALERT) INC: F58130212000061 TYP: ALS MEDICAL CALL AD: 44 MERRIEWOLD LN N CTY: SOUTH BLOOMING CN: JOHANNA TORPEY CMT1",
        "ken@cadpage.org",
        "OC911 ALERT",
        "INC: F58130212000061 TYP: ALS MEDICAL CALL AD: 44 MERRIEWOLD LN N CTY: SOUTH BLOOMING CN: JOHANNA TORPEY CMT1", 1, 3);
        
        
    doParseTest("CODouglasCountyB",
        "ken@cadpage.org",
        "",
        ...
        "Group_Page_Notification@usamobility.net",
        "",
        "w/West Douglas:01/28 18:28 AE-24-A 4909 Woodley Ave LOCK OUT EMERGENT WDF2,M39,E39,BC34 Received: Mon Jan 28, 6:28 pm");
    
    doParseTest("VALexingtonRockbridgeCounty",
        "ken@cadpage.org",
        "",
        "ALERTROCKBRIDGE  (1/2) [CAD] Type: EMS-FX/DIS Loc: ROCKBRIDGE MIDDLE SCHOOL Units: CO07A,FAIR1, City: ROCKBRIDGE COUNTY 12/27/2012 2:47:49 STOP",
        "ken@cadpage.org",
        "CAD",
        "Type: EMS-FX/DIS Loc: ROCKBRIDGE MIDDLE SCHOOL Units: CO07A,FAIR1, City: ROCKBRIDGE COUNTY 12/27/2012 2:47:49", 1, 2);
    ...
    doParseTest("TXCollinCounty",
        ...
        "ics.gateway@wylietexas.gov",
        "Message From Wylie",
        "12030523 RESCUE-TRAPPED PERSON(S) TONY LN / N HIGHWAY 66 IN FATE [FAFD GRID: F121] UNITS: FATEFD ROMED1 ST RMK: <NONE> CFS RMK 12:48 VEHICLE ON ITS SIDE AND OCCP TRAPPED {WYPCCOM05 12:48}");
    
    doParseTest("NCLincolnCounty",
        "ken@cadpage.org",
        "",
        "1/3634:CAD:UFD-1200000194-SERVICE CALL OR CITIZEN ASSIST-2700 TRINITY CHURCH RD-TRINITY LUTHERAN CHURCH-REEPSVILLE RD-ZUR LEONARD RD-9am-10am [10/18/12",
        "ken@cadpage.org",
        "",
        "634:CAD:UFD-1200000194-SERVICE CALL OR CITIZEN ASSIST-2700 TRINITY CHURCH RD-TRINITY LUTHERAN CHURCH-REEPSVILLE RD-ZUR LEONARD RD-9am-10am [10/18/12",
        1, 3);
