...
public class CTNewHavenCountyAParserTest extends BaseParserTest {
  
  public CTNewHavenCountyAParserTest() {
    setParser(new CTNewHavenCountyAParser(), "NEW HAVEN COUNTY", "CT");
  }
  ...
  public static void main(String[] args) {
    new CTNewHavenCountyAParserTest().generateTests("T1", "PRI CALL ADDR CITY SRC INFO");
  }
}