...
public class NJBurlingtonCountyAParserTest extends BaseParserTest {
  
  public NJBurlingtonCountyAParserTest() {
    setParser(new NJBurlingtonCountyAParser(), "BURLINGTON COUNTY", "NJ");
  }
  ...
  public static void main(String[] args) {
    new NJBurlingtonCountyAParserTest().generateTests("T1");
  }
}