...
public class NCHarnettCountyBParserTest extends BaseParserTest {
  ...
  public NCHarnettCountyBParserTest() {
    setParser(new NCHarnettCountyBParser(), "HAYWOOD COUNTY", "NC");
  }
  ...
  public static void main(String[] args) {
    new NCHarnettCountyBParserTest().generateTests("T1", "PLACE ADDR CITY X NAME PHONE CODE ID TIME CALL INFO");
  }
}
