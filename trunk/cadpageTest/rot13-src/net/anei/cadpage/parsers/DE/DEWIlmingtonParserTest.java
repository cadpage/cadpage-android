...
choyvp pynff QRJVyzvatgbaCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp QRJVyzvatgbaCnefreGrfg() {
    frgCnefre(arj QRJvyzvatgbaCnefre(), "JVYZVATGBA", "QR");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G2",
        ...
        "NQQE:1202 SNVEIVRJ NI",
        "ZNQQE:1202 SNVEIVRJ NIR",
        "K:ZNCYR NI",
        "CYNPR:UBYYL BNX GREENPR",
        "VASB:ZNYR FHOWRPG ZNPRQ //APPCQ RAE");

    qbGrfg("G3",
        "08/14/2011*08:19*PIN - ABG NYREG*207 EBJYNAQ CNEX OY ogja UVYYF*PNEEPEBSG",
        "PNYY:PIN - ABG NYREG",
        "NQQE:207 EBJYNAQ CNEX OY",
        "K:UVYYF",
        "CYNPR:PNEEPEBSG");
    ...
    qbGrfg("G4",
        "08/14/2011*16:00*Y2*RYRPGEVPNY BQBE VAFVQR*1304 UVYYFVQR NI ogja J PYRNEI*UBYYL BNX GREENPR",
        "CEV:Y2",
        "PNYY:RYRPGEVPNY BQBE VAFVQR",
        "NQQE:1304 UVYYFVQR NI",
        "ZNQQE:1304 UVYYFVQR NIR",
        "K:J PYRNEI",
        "CYNPR:UBYYL BNX GREENPR");
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj QRJVyzvatgbaCnefreGrfg().trarengrGrfgf("G1");
  }
}
