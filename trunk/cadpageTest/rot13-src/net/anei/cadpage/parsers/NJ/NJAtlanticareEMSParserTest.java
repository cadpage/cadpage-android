...
choyvp pynff AWNgynagvpnerRZFCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp AWNgynagvpnerRZFCnefreGrfg() {
    frgCnefre(arj AWNgynagvpnerRZFCnefre(), "", "AW");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        ...
        "PNYY:YVAJBBQ-RZF",
        "NQQE:199 ARJ EQ",
        "CYNPR:ynj bssvpr va prageny fdhner",
        "PVGL:YVAJBBQ");
  ...
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj AWNgynagvpnerRZFCnefreGrfg().trarengrGrfgf("G1");
  }
}