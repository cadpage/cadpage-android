...
(Qvfcngpu Zrffntr) GENSSVP PENFU:VAWHEL  \aOEBFVHF & PRAGRE FG     \a1 IRUVPYR ZIN EBYYBIRE JVGU VAWHEVRF :-)
...
choyvp pynff BUCbegntrPbhaglOCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ibvq grfgTneerggfivyyrSerrqbzAryfbaWbvagSverQvfg() {
    ...
    qbGrfg("G4",
        ...
        "PVGL:TNEERGGFIVYYR",
        "VASB:PURZVPNY BQBE B.b");

    qbGrfg("G5",
        "(Qvfcngpu Zrffntr) qvfertneq sver nynez\a11185  PRAGRE EQ    ARYFBA GJC",
        "PNYY:qvfertneq sver nynez",
        "NQQE:11185 PRAGRE EQ",
        "PVGL:ARYFBA GJC");
    ...
    qbGrfg("G7",
        "(Qvfcngpu Zrffntr) SVER  \eCNFF OEBFVHF & CVREPR EQ    ARYFBA GJC \eCvrepr Ebnq jbbq cvyrf ba evtug orsber phyire",
        "PNYY:SVER",
        "NQQE:CNFF OEBFVHF & CVREPR EQ",
        "PVGL:ARYFBA GJC",
        "VASB:Cvrepr Ebnq jbbq cvyrf ba evtug orsber phyire");

    qbGrfg("G8",
        "(Qvfcngpu Zrffntr) SVER  \e8291  FGNGR EG 88    SERRQBZ GJC \ebqbe be ryrpgevpny fzryy va sybbqrq onfrzrag",
        "PNYY:SVER",
        "NQQE:8291 FGNGR EG 88",
        "ZNQQE:8291 FGNGR 88",
        "PVGL:SERRQBZ GJC",
        "VASB:bqbe be ryrpgevpny fzryy va sybbqrq onfrzrag");

    qbGrfg("G9",
        "(Qvfcngpu Zrffntr) SVER  \aFVYVPN FG & YVOREGL FG    TNEERGGFIVYYR \aGBJ GEHPX BA SVER :-)",
        "PNYY:SVER",
        "NQQE:FVYVPN FG & YVOREGL FG",
        "PVGL:TNEERGGFIVYYR",
    ...
    qbGrfg("G10",
        "(Qvfcngpu Zrffntr) SVER  \a10376  OEBFVHF EQ  37   \agenvyre sver",
        "PNYY:SVER",
        "NQQE:10376 OEBFVHF EQ",
        "NCG:37",
        "VASB:genvyre sver");

    qbGrfg("G11",
        "(Qvfcngpu Zrffntr)   Zhghny Nvq sbe Znaghn/Uvenz\a7717  FGNGR EG 305     \aratvar & gnaxre Fdhnq sebz Pbzzhavgl Trareny Nynez",
        "PNYY:Zhghny Nvq sbe Znaghn/Uvenz",
        "NQQE:7717 FGNGR EG 305",
        "ZNQQE:7717 FGNGR 305",
        "VASB:ratvar & gnaxre Fdhnq sebz Pbzzhavgl Trareny Nynez");
    ...
    qbGrfg("G13",
        "(Qvfcngpu Zrffntr) SVER  \e20  CVARPERFG     \ezhghny nvq   jngre fuhggyr",
        "PNYY:SVER",
        "NQQE:20 CVARPERFG",  // Abg znccvat
        "VASB:zhghny nvq   jngre fuhggyr");
    ...
    qbGrfg("G14",
        ...
        "NQQE:FBHGU FG",
        "NCG:OEVQTR",
        "VASB:0903 BA FPRAR, FHOWRPG WHZCRQ BSS OEVQTR");
    ...
    qbGrfg("G16",
        ...
        "NQQE:FE 700",
        "ZNQQE:BU 700",
        "VASB:fe 700 orsber BGP...bar pne...uvg gerr...ab sver..");
    ...
    qbGrfg("G20",
        "(Qvfcngpu Zrffntr) GENSSVP PENFU:VAWHEL \a9727  FGNGR EG 88   \aBAR PNE IF CBYR JVGU JVERF QBJA :-(",
        "PNYY:GENSSVP PENFU:VAWHEL",
        "NQQE:9727 FGNGR EG 88",
        "ZNQQE:9727 FGNGR 88",
        "VASB:BAR PNE IF CBYR JVGU JVERF QBJA :-(");

    qbGrfg("G21",
        "(Qvfcngpu Zrffntr) SVER \a9419  AVPUBYF EQ   \aZf. Cbby ercbegf bcra ohea bs n qrzbyvfurq ubhfr",
        "PNYY:SVER",
        "NQQE:9419 AVPUBYF EQ",
        "VASB:Zf. Cbby ercbegf bcra ohea bs n qrzbyvfurq ubhfr");

    qbGrfg("G22",
        "(Qvfcngpu Zrffntr) SVER \e9419  AVPUBYF EQ   \e20 sg bcra ohea bs pbafgehpgvba zngrevny sebz",
        "PNYY:SVER",
        "NQQE:9419 AVPUBYF EQ",
        "VASB:20 sg bcra ohea bs pbafgehpgvba zngrevny sebz");
    ...
    qbGrfg("G23",
        ...
        "NQQE:198 JO",
        "ZNQQE:198",
        "VASB:1 PNE IF. JNYY JVGU RAGENCZRAG");
    ...
    qbGrfg("G25",
        "(Qvfcngpu Zrffntr)  \agenssvp penfu\azvyr rnfg bs Cnexzna..vawhevrf FE 422",
        "PNYY:genssvp penfu",
        "NQQE:zvyr rnfg bs Cnexzna",
        "ZNQQE:zvyr & Cnexzna",
        "VASB:vawhevrf FE 422");
    ...
    qbGrfg("G26",
        ...
        "VASB:pnapryy cre NQG naq ubzr bjare");
    ...
    qbGrfg("G27",
        ...
        "NQQE:12126 FE 282",
        "ZNQQE:12126 BU 282",
        "VASB:sver nynez   Evyrl");

    qbGrfg("G28",
        "(Qvfcngpu Zrffntr) SVER \a10134  YVZREVQTR EQ   \aCBFFVOYR PB NYNEZ :-\\",
        "PNYY:SVER",
        "NQQE:10134 YVZREVQTR EQ",
        "VASB:CBFFVOYR PB NYNEZ :-\\");

    qbGrfg("G29",
        "(Qvfcngpu Zrffntr) GENSSVP PENFU \e303  FYNTYR EQ   \ebar pne, bhg bs gur pne",
        "PNYY:GENSSVP PENFU",
        "NQQE:303 FYNTYR EQ",
        "VASB:bar pne, bhg bs gur pne");
    ...
    qbGrfg("G31",
        "(Qvfcngpu Zrffntr) SVER \a8077  SERRQBZ EQ   \aSVER NYNEZ, UNYYJNL FZBXR QRGRPGBE :-(",
        "PNYY:SVER",
        "NQQE:8077 SERRQBZ EQ",
        "VASB:SVER NYNEZ, UNYYJNL FZBXR QRGRPGBE :-(");

    qbGrfg("G32",
        "(Qvfcngpu Zrffntr)  \eABEGU BS PVEPYR  CNEXZNA EQ   \eina ebyy bire",
        "PNYY:ABEGU BS PVEPYR  CNEXZNA EQ",
        "NQQE:ina ebyy bire");
    ...
    qbGrfg("G34",
        "(Qvfcngpu Zrffntr) GENSSVP PENFU:VAWHEL \eYVZREVQTR EQ  FGNGR EG 303   \e2 IRUVPYR ZIN",
        "PNYY:GENSSVP PENFU:VAWHEL",
        "NQQE:YVZREVQTR EQ & FGNGR EG 303",
        "ZNQQE:YVZREVQTR EQ & FGNGR 303",
        "VASB:2 IRUVPYR ZIN");

    qbGrfg("G35",
        "(Qvfcngpu Zrffntr) NFFVFG SVER QRCNEGZRAG \a8569  FGNGR EG 303   \aNHGB NVQ - PUVZARL SVER - GNAXRE NAQ RATVAR ERDHRFGRQ",
        "PNYY:NFFVFG SVER QRCNEGZRAG",
        "NQQE:8569 FGNGR EG 303",
        "ZNQQE:8569 FGNGR 303",
        "VASB:NHGB NVQ - PUVZARL SVER - GNAXRE NAQ RATVAR ERDHRFGRQ");

    qbGrfg("G36",
        "(Qvfcngpu Zrffntr) SVER \aAVPUBYF EQ  FGNGR EG 303   \aTENFF SVER ORGJRRA AVPUBYF NAQ FYNTYR, FBHGU FVQR",
        "PNYY:SVER",
        "NQQE:AVPUBYF EQ & FGNGR EG 303",
        "ZNQQE:AVPUBYF EQ & FGNGR 303",
        "VASB:TENFF SVER ORGJRRA AVPUBYF NAQ FYNTYR, FBHGU FVQR");

    qbGrfg("G37",
        "(Qvfcngpu Zrffntr) SVER \e     \ebcra ohea orgjrra oevqtr naq Pragre ba Oebfvhf",
        "PNYY:SVER",
        "VASB:bcra ohea orgjrra oevqtr naq Pragre ba Oebfvhf");
    ...
    qbGrfg("G39",
        "(Qvfcngpu Zrffntr) FGBEZ QNZNTR \aNFOHEL & FG EG 700 / BA FGNGR EG 303   \aGERR QBJA NPEBFF JRFGOBHAQ YNAR",
        "PNYY:FGBEZ QNZNTR",
        "NQQE:NFOHEL & FG EG 700 & BA FGNGR EG 303",
        "ZNQQE:NFOHEL & BU 700 & BA FGNGR 303",
        "VASB:GERR QBJA NPEBFF JRFGOBHAQ YNAR");

    qbGrfg("G40",
        "(Qvfcngpu Zrffntr) SVER \a8937  FGNGR EG 88   \aTENFF SVER ARNE TNF YVAR",
        "PNYY:SVER",
        "NQQE:8937 FGNGR EG 88",
        "ZNQQE:8937 FGNGR 88",
        "VASB:TENFF SVER ARNE TNF YVAR");
    ...
    qbGrfg("G42",
        ...
        "PNYY:SVER",
        "NQQE:9599 NFOHEL EQ",
        "VASB:ZNACBJRE ARRQRQ SBE PBZZHAVGL");

    qbGrfg("G43",
        "(Qvfcngpu Zrffntr) SVER \a8880  FGNGR EG 305   \aBQBE BS CEBCNAR VA N ERFVQRAPR :)",
        "PNYY:SVER",
        "NQQE:8880 FGNGR EG 305",
        "ZNQQE:8880 FGNGR 305",
        "VASB:BQBE BS CEBCNAR VA N ERFVQRAPR :)");

    qbGrfg("G44",
        "(Qvfcngpu Zrffntr) SVER \a12834  FGNGR EG 88   \aSVER NYNEZ UNYYJNL FZBXR QRGRPGBE :-)",
        "PNYY:SVER",
        "NQQE:12834 FGNGR EG 88",
        "ZNQQE:12834 FGNGR 88",
        "VASB:SVER NYNEZ UNYYJNL FZBXR QRGRPGBE :-)");

    qbGrfg("G45",
        "(Qvfcngpu Zrffntr) SVER \a9035  ZNCYR TEBIR EQ  P \aYNQQRE GEHPX SBE JVAQUNZ FZBXR QRGRPGBE TBVAT BSS :-\\",
        "PNYY:SVER",
        "NQQE:9035 ZNCYR TEBIR EQ",
        "NCG:P",
        "VASB:YNQQRE GEHPX SBE JVAQUNZ FZBXR QRGRPGBE TBVAT BSS :-\\");

    qbGrfg("G46",
        "(Qvfcngpu Zrffntr) SVER \a7862  FGNGR FG   \aFGEBAT BQBE BS TNF VA GUR XVGPURA :-)",
        "PNYY:SVER",
        "NQQE:7862 FGNGR FG",
        "VASB:FGEBAT BQBE BS TNF VA GUR XVGPURA :-)");

    qbGrfg("G47",
        "(Qvfcngpu Zrffntr) SVER \a UVAFQNYR\aZNYR SRYY SEBZ GUR EBBS, YNQQRE GEHPX ZHGHNY NVQ SBE UVENZ",
        "PNYY:SVER",
        "NQQE:UVAFQNYR",
        "VASB:ZNYR SRYY SEBZ GUR EBBS, YNQQRE GEHPX ZHGHNY NVQ SBE UVENZ");

    qbGrfg("G48",
        "(Qvfcngpu Zrffntr) SVER \e     \e sver nynez oenql yrnc cynmn..",
        "PNYY:SVER",
        "VASB:sver nynez oenql yrnc cynmn..");
    ...
    qbGrfg("G50",
        ...
        "PNYY:ZIN",
        "NQQE:aryfba pvepyr",
        "VASB:nzvfu ohttl if pne");

    qbGrfg("G51",
        "(Qvfcngpu Zrffntr) Genssvp Nppvqrag\aF BS 303  AVPUBYF EQ   \aIruvpyr va n Qvgpu  vagbkvpngrq pnag ebyy qbja gur jvaqbj",
        "PNYY:Genssvp Nppvqrag",
        "NQQE:F BS 303 AVPUBYF EQ",
        "VASB:Iruvpyr va n Qvgpu  vagbkvpngrq pnag ebyy qbja gur jvaqbj");

    qbGrfg("G52",
        "(Qvfcngpu Zrffntr)  NERN BS 11420 XLYR EQ\aCBYR NAQ JVERF QBJA\a1600 RAG GB FGNGVBA",
        "PNYY:NERN BS 11420 XLYR EQ",
        "NQQE:CBYR NAQ JVERF QBJA",
        "ZNQQE:CBYR & JVERF QBJA",
        "VASB:1600 RAG GB FGNGVBA");

    qbGrfg("G53",
        "(Qvfcngpu Zrffntr)  ZIN\a6639  FGNGR EG 303   \a Iruvpyr va n Qvgpu Pnyyre qvq abg frr nalbar trg bhg",
        "PNYY:ZIN",
        "NQQE:6639 FGNGR EG 303",
        "ZNQQE:6639 FGNGR 303",
        "VASB:Iruvpyr va n Qvgpu Pnyyre qvq abg frr nalbar trg bhg");

    qbGrfg("G54",
        "(Qvfcngpu Zrffntr) SVER \a9780  URZYBPX YA   \a Ryrpgevp PB Nynez jvgu Onggrel Onpx hc whfg chepunfrq gbqnl,",
        "PNYY:SVER",
        "NQQE:9780 URZYBPX YA",
        "VASB:Ryrpgevp PB Nynez jvgu Onggrel Onpx hc whfg chepunfrq gbqnl,");
    ...
    qbGrfg("G56",
        "(Qvfcngpu Zrffntr) FDHNQ ERDHRFG \a10228  FGNGR EG 82   \aznacbjre arrqrq ng nobir",
        "PNYY:FDHNQ ERDHRFG",
        "NQQE:10228 FGNGR EG 82",
        "ZNQQE:10228 FGNGR 82",
        "VASB:znacbjre arrqrq ng nobir");
    ...
    qbGrfg("G59",
        "(Qvfcngpu Zrffntr) FGBEZ QNZNTR \eERLABYQF EQ  FGNGR EG 422   \eGERR QBJA NPEBFF GUR EBNQJNL",
        "PNYY:FGBEZ QNZNTR",
        "NQQE:ERLABYQF EQ & FGNGR EG 422",
        "ZNQQE:ERLABYQF EQ & FGNGR 422",
        "VASB:GERR QBJA NPEBFF GUR EBNQJNL");

    qbGrfg("G60",
        "(Qvfcngpu Zrffntr) GENSSVP PENFU:VAWHEL \a197 ROBHAQ  GHEACVXR   \aZIN JVGU VAWHEVRF, GJB FRZVf, SVER VAIBYIRQ",
        "PNYY:GENSSVP PENFU:VAWHEL",
        "NQQE:197 ROBHAQ GHEACVXR",
        "VASB:ZIN JVGU VAWHEVRF, GJB FRZVf, SVER VAIBYIRQ");

    qbGrfg("G61",
        "(Qvfcngpu Zrffntr) SVER \a9639  FGNGR EG 303   \aZHGHNY NVQ GB JVAQUNZ ZNACBJRE SEBZ SVER SBE N YVSG NFFVFG -\\",
        "PNYY:SVER",
        "NQQE:9639 FGNGR EG 303",
        "ZNQQE:9639 FGNGR 303",
        "VASB:ZHGHNY NVQ GB JVAQUNZ ZNACBJRE SEBZ SVER SBE N YVSG NFFVFG -\\");
    ...
    qbGrfg("G64",
        ...
        "PNYY:SVER",
        "NQQE:8280 CNEX NIR",
        "VASB:ubhfr gb cbyr..npebff fgerrg..ybj unatvat jver");

    qbGrfg("G65",
        "(Qvfcngpu Zrffntr) SVER \aARKG QBBE GB 7581  FZNYYRL EQ   \aERXVAQYR BS GUR TNENTR SVER",
        "PNYY:SVER",
        "NQQE:ARKG QBBE GB 7581 FZNYYRL EQ",
        "VASB:ERXVAQYR BS GUR TNENTR SVER");

    qbGrfg("G66",
        "(Qvfcngpu Zrffntr)  Tnentr Sver Pybfr gb gur ubhfr\a7565  FZNYYRL EQ",
        "PNYY:Tnentr Sver Pybfr gb gur ubhfr",
        "NQQE:7565 FZNYYRL EQ");
