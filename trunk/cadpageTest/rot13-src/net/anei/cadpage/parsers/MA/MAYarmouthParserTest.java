...
choyvp pynff ZNLnezbhguCnefreGrfg rkgraqf OnfrCnefreGrfg {
  ...
  choyvp ZNLnezbhguCnefreGrfg() {
    frgCnefre(arj ZNLnezbhguCnefre(), "LNEZBHGU", "ZN");
  }
  ...
  choyvp ibvq grfgCnefre() {
    ...
    qbGrfg("G1",
        " 109 ABGGVATUNZ QE\aAB ANZR\aLNEZBHGU\aZrqvpny Cevbevgl 2/3\a2_Rnfg_1\a\aAbgrf\aCBFFVOYR HANGGRAQRQ",
        "NQQE:109 ABGGVATUNZ QE",
        "CEV:2",
        "ZNC:2_Rnfg_1",
        "PNYY:CBFFVOYR HANGGRAQRQ");

    qbGrfg("G2",
        " 579 OHPX VFYNAQ EQ\aZNLSYBJRE CYNPR\aLNEZBHGU\aZrqvpny Cevbevgl 2/3\a3_Fbhgu_1\a\aAbgrf\aOERJFGRE HAVG RLR FJRYYVAT",
        "NQQE:579 OHPX VFYNAQ EQ",
        "CYNPR:ZNLSYBJRE CYNPR",
        "CEV:2",
        "ZNC:3_Fbhgu_1",
        "PNYY:OERJFGRE HAVG RLR FJRYYVAT");

    qbGrfg("G3",
        " 43 ZRQVANU QE\a2_Jrfg_3\a\aAbgrf\aQRULQENGVBA FUBEGARFF BS OERNGU",
        "NQQE:43 ZRQVANU QE",
        "ZNC:2_Jrfg_3",
        "PNYY:QRULQENGVBA FUBEGARFF BS OERNGU");

    qbGrfg("G4",
        " 55 PBGGBAJBBQ FG\aONPX CNVA",
        "NQQE:55 PBGGBAJBBQ FG",
        "PNYY:ONPX CNVA");
    ...
    qbGrfg("G5",
        ...
        "NQQE:19 SYVPXRE YA",
        "ZNC:1_Rnfg_2",
        "PNYY:87 L/B ZNYR QVSS OERNGUVAT");
    ...
    qbGrfg("G9",
        ...
        "NQQE:6 FDHVEERY EHA",
        "ZNC:2_Jrfg_3",
        "PNYY:PB Nflzcgbzngvp");

    qbGrfg("G10",
        " 0 EBHGR 6\aAB ANZR\aLNEZBHGU\aZIP\aZVQ-PNCR UVTUJNL\a\aAbgrf\a6 RNFG OBHAQ WHFG CNFG RKVG 8\a",
        "NQQE:EBHGR 6",
        "PNYY:ZIP",
        "VASB:ZVQ-PNCR UVTUJNL / 6 RNFG OBHAQ WHFG CNFG RKVG 8");
    
  }
  
  choyvp fgngvp ibvq znva(Fgevat[] netf) {
    arj ZNLnezbhguCnefreGrfg().trarengrGrfgf("G1", "NQQE CYNPR CEV ZNC PNYY VASB");
  }
}