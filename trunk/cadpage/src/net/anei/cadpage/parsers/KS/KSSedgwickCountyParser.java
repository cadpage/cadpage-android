...
public class KSSedgwickCountyParser extends DispatchA21Parser {
  ...
  private static final Properties CALL_CODES = buildCodeTable(new String[]{
      ...
      "F48T",     "Injury Accident with Pin",
      "FABDOA",   "Abdominal Pain",
      "FALL",     "Fall",
      "FASSTC",   "Assist a Citizen",
      "FASSTE",   "Assist a Citizen",
      "FBACKA",   "Back Pain",
      "FBLUEA",   "Code Blue",
      "FBLUEC",   "Code Blue",
      "FBLUED",   "Code Blue",
      ...
      "FCHESD",   "Chest Pain",
      "FCUT",     "Cutting",
      "FDIABC",   "Diabetic Emergency",
      "FDIFFD",   "Difficulty Breathing",
      "FFALLA",   "Fall",
      "FFALLA",   "Fall",
      "FFALLB",   "Fall",
      "FFALLD",   "Fall",
