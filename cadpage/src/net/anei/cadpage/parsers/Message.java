...
public class Message {
  ...
  public Message(boolean preParse, String fromAddress, String subject, String body, SplitMsgOptions options, boolean follow) {
    ...
    if (! preParse) {
      ...
      this.parseMessageBody = finish(body, follow, options);
    } else {
  ...
  private void preParse(String fromAddress, String subject, String body, 
                        boolean follow, SplitMsgOptions options) {
    ...
    body = finish(body, follow, options);
   ...
   * @param body message body
   * @param follow true if we have determined this is a subsequent split alert message
   * @param options split message processing options
   * @return adjusted message body
   */
  private String finish(String body, boolean follow, SplitMsgOptions options) {
  ...
  private String cleanParenSubject(String body) {
