...
public class VAFranklinCountyParser extends SmartAddressParser {
  
  private static final String DEF_STATE = "VA";
  private static final String DEF_CITY = "FRANKLIN";
  ...
  private static final Pattern MARKER = Pattern.compile("\\b[SC]\\d\\d\\b");
