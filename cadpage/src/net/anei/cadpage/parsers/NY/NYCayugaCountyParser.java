...
public class NYCayugaCountyParser extends SmartAddressParser {
  ...
  public String getFilter() {
    return "cayuga911@co.cayuga.ny.us,cayuga911@nameservices.net,cayuga911@www.cayugacounty.us,messaging@iamresponding.com,dspingler@cayugacounty.us";
  }

  @Override
  protected boolean parseMsg(String subject, String body, Data data) {
    
    // Try to pare new format page
    ...
    if (match.find()) {
      ...
      // Next come cross street information, which might come in two parts
      // separated by a comma
      String cross = "";
      int pt = body.indexOf(',');
      if (pt >= 0) {
        cross = body.substring(0,pt).trim();
        if (checkAddress(cross) > 0) {
    ...
    // Try to parse older format page
    ...
    // Not  recognized dispatch pattern.  See if this should be a general alert
    if (subject.equals("From 911 Center") || subject.equals("From911Center")) {
