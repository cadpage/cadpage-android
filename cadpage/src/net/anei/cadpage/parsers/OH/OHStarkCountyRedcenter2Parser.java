...
public class OHStarkCountyRedcenter2Parser extends FieldProgramParser {
  ...
  public OHStarkCountyRedcenter2Parser() {
    super("STARK COUNTY", "OH", 
          "( Call:CALL! Date/Time:DATETIME1! ( Place:PLACE! Address:ADDRCITY! | Address:ADDRCITY! Place:PLACE ) Crosses:X! Section:MAP? Run_Num:ID? Unit:SKIP? Alert:INFO1! Info:INFO% Map:TIMES1+ " +
  ...
  public String getFilter() {
    return "@starksheriff.org,@redcenter.us,@neo-comm.org,7127390583,messaging@iamresponding.com,@cantonohio.gov,77720";
  }
