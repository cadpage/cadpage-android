...
Trumbull County, OH
Contact: Active911
Agency name: Bazetta Twp. Fire Rescue Location: Cortland, OH 
Sender: er911@co.trumbull.oh.us
System: Vision Air
...
public class OHTrumbullCountyParser extends DispatchVisionAirParser {
  ...
  public String getFilter() {
    return "er911@co.trumbull.oh.us";
  }
  
  @Override
  public boolean parseMsg(String body, Data data) {
    
    // The basic format expects "* " field delimiters, but we seem to have removed those
    // and need to put them back
    Matcher match = MARKER.matcher(body);
    if (!match.find()) return false;
    int pt = match.start();
    String trail = body.substring(pt);
