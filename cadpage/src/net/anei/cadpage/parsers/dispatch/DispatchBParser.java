...
public class DispatchBParser extends FieldProgramParser {
  ...
  private void setup() {
    ...
    setupCallList(
        ...
        "AUTO ACCIDENT NO INJURIES STRAIGHT FRK",
        "AUTO ACCIDENT WITH INJURIES",
        "AUTO ACCIDENT UNKNOWN",
        "AUTO ACCIDENT UNKNOWN INJURIES",
        "AUTO ACCIDENT UNKNOWN INJURIES LOWER BIG CRK",
        "AUTO ACCIDENT UNKNOWN INJURIES MEADE HOLW",
        "AUTO ACCIDENT UNKNOWN INJURIES STATE",
        "AUTO ACCIDENT UNKNOWN INJURIES UPPER MUD",
        "AUTO ACCIDENT UNKNOWN INJURIES LOWER MUD",
        "AUTO ALARM/FIRE",
        "BACK PAIN",
        "BASIC LIFE SUPPORT",
        ...
        "SEVERE T-STORM WILL HIT NW",
        "SEVERE T-STORM WATCH TIL 23:00",
        "SHOOTING",
        "SICK",
        "SICK PERSON",
        "SICK PERSON CHARLIE",
