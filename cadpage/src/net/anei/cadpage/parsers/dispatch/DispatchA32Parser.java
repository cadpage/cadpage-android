...
public class DispatchA32Parser extends FieldProgramParser {
  ...
  public DispatchA32Parser(String[] cityList, String defCity, String defState) {
    super(cityList, defCity, defState,
          "( ADDR CALL! | CALL ( DATETIME2 District:MAP? NAME? ADDR/Z CITY_ST! | ( ADDR_PL ADDR_PL ADDR_PL2 CITY! | ADDR_PL ADDR_PL2 CITY! | ADDR/Z CITY! | PLACE ADDR! INFO | ADDR! INFO ) District:MAP? INFO+? DATETIME ) ) INFO+");
  }
