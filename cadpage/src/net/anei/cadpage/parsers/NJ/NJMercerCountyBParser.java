...
public class NJMercerCountyBParser extends HtmlParser {
  ...
  public String getProgram() {
    return append(getOptGroup(super.getProgram()), " ", "ADDR X CITY APT PLACE MAP UNIT CALL");
  }
 ...
 //   makeFile("/home/brennus/html/NJMercerCountyB-"+ct+".html");
 //   ct++;
    
    if (getValue("LOCATION").equals("")) {
