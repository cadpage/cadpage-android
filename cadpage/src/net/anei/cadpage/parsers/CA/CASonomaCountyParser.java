...
public class CASonomaCountyParser extends FieldProgramParser {
  ...
  private static final String[] STATION_LIST = new String[]{
    "BBY",  // Bodega Bay
    "BLO",  // Bloomfield
    "BOD",  // ???
    "VFR"   // Valley Ford
  ...
  public CASonomaCountyParser() {
    super(STATION_LIST, "SONOMA COUNTY", "CA",
           "Loc:ADDR! BOX:BOX! TYP:CALL! CN:NAME CC:PHONE TYPE_CODE:SKIP CALLER_NAME:NAME CALLER_ADDR:SKIP TIME:SKIP COM:INFO");
  }
